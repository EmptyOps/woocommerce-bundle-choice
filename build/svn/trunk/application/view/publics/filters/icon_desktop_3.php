...
?>
<div class="spui-semantic-<?php echo esc_attr($term->slug); ?>-shape-column <?php echo esc_attr($width_class); ?>" data-tab-group="<?php echo esc_attr($tab_set); ?>">
	<p>
		...
		<?php foreach ($list as $filter_icon): ?>
			<div title="<?php esc_attr($filter_icon["name"]); ?>"
				class="eo_wbc_filter_icon column <?php echo $non_edit ? 'none_editable':'' ?> 
					<?php echo $filter_icon['mark'] ? 'eo_wbc_filter_icon_select':''?> ui image spui-semantic-diamond-shape" data-single_select="<?php echo esc_attr($is_single_select); ?>"
