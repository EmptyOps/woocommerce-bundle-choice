...
?>
			...
			<div class="ui form segment">
			  	<div class="grouped fields">
					...
					<div class=" field">
					    <div class="ui toggle checkbox">
					      	<input type="checkbox" tabindex="0" class="hidden" name="guidance_tool" value="1" <?php echo array_key_exists('guidance_tool', $feature_option/*$feature_option*/)?'checked="checked"':''; ?>>
	 					...
	 					<div class="grouped fields">
							<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="filters_shortcode" id="filters_shortcode" <?php echo array_key_exists('filters_shortcode', $bonus_features/*$bonus_features*/)?'checked="checked"':''; ?> value="filters_shortcode">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="filters_shop_cat" id="filters_shop_cat" <?php echo array_key_exists('filters_shop_cat', $bonus_features/*$bonus_features*/)?'checked="checked"':''; ?> value="filters_shop_cat">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="opts_uis_item_page" id="opts_uis_item_page" <?php echo array_key_exists('opts_uis_item_page', $bonus_features/*$bonus_features*/)?'checked="checked"':''; ?> value="opts_uis_item_page">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="spec_view_item_page" id="spec_view_item_page" <?php echo array_key_exists('spec_view_item_page', $bonus_features/*$bonus_features*/)?'checked="checked"':''; ?> value="spec_view_item_page">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="price_control" id="price_control" <?php echo array_key_exists('price_control', $bonus_features/*$bonus_features*/)?'checked="checked"':''; ?> value="price_control">
