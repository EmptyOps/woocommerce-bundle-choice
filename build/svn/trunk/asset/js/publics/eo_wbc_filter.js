...
if( typeof(eo_wbc_object) != 'undefined'){
	...
	function eowbc_yith_wishlist_fix(){
		...
		jQuery(document).ready((function(t) {
				...
				if (void 0 !== t.prettyPhoto) {
					...
					t('a[data-rel^="prettyPhoto[add_to_wishlist_"]').add('a[data-rel="prettyPhoto[ask_an_estimate]"]').add('a[data-rel="prettyPhoto[create_wishlist]"]').unbind("click").prettyPhoto(e), t('a[data-rel="prettyPhoto[move_to_another_wishlist]"]').on("click", (function() {
						var i = t(this),
							...
							a = e.find(".row-id"),
							o = i.closest("[data-row-id]").data("row-id");
						a.length && a.remove(), e.append('<input type="hidden" name="row_id" class="row-id" value="' + o + '"/>')
					})).prettyPhoto(e);
					var a = function(i, e) {
					...
					new MutationObserver((function(t) {
						for (var i in t) {
							var e = t[i];
							"childList" === e.type && (void 0 !== e.addedNodes && e.addedNodes.forEach(o), void 0 !== e.removedNodes && e.removedNodes.forEach(n))
						}
			...
			function n() {
				i(), e(), a(), o(), l(), s(), _(), d(), c(), r(), t(document).trigger("yith_wcwl_init_after_ajax")
			}
				...
				yith_wcwl_l10n.enable_tooltip && t(".yith-wcwl-add-to-wishlist").find("[data-title]").each((function() {
					...
					i.hasClass("tooltip-added") || (i.on("mouseenter", (function() {
						...
						a = t("<span>", {
							...
							text: e.data("title")
						}), e.append(a), i = a.outerWidth() + 6, a.outerWidth(i), n = (o - i) / 2, a.css({
							left: n.toFixed(0) + "px"
					...
					i.sortable({
						...
						update: function() {
							...
							a.length && (e && e.abort(), a.each((function() {
								var i = t(this);
								i.find('input[name*="[position]"]').val(n++), o.push(i.data("row-id"))
							})), e = t.ajax({
								data: {
			...
			function c() {
				...
				t(".wishlist_table").on("change", ".product-quantity input", (function() {
					var a = t(this),
						o = a.closest("[data-row-id]"),
						n = o.data("row-id"),
						s = a.closest(".wishlist_table"),
						l = s.data("token");
					clearTimeout(e), o.find(".add_to_cart").attr("data-quantity", a.val()), e = setTimeout((function() {
						i && i.abort(), i = t.ajax({
							beforeSend: function() {
								b(s)
							},
			...
			function _() {
				t(".wishlist_table").filter(".images_grid").not(".enhanced").on("click", "[data-row-id] .product-thumbnail a", (function(i) {
					var e = t(this).closest("[data-row-id]"),
						...
						o = e.find(".item-details");
					i.preventDefault(), o.length && (a.removeClass("show"), e.toggleClass("show"))
			...
			function h(i, e, a) {
				i.action = yith_wcwl_l10n.actions.move_to_another_wishlist_action, "" !== i.wishlist_token && "" !== i.destination_wishlist_token && "" !== i.item_id && t.ajax({
					beforeSend: e,
					url: yith_wcwl_l10n.ajax_url,
					data: i,
					dataType: "json",
					method: "post",
					success: function(e) {
						a(e), n(), t("body").trigger("moved_to_another_wishlist", [t(this), i.item_id])
					}
				})
			}
			...
			function w(i) {
				...
				t.ajax({
					...
					method: "post",
					success: function(e) {
						void 0 !== e.fragments && T(e.fragments), n(), t("body").trigger("removed_from_wishlist", [i, a])
					},
					url: yith_wcwl_l10n.ajax_url
				})
			}
			...
			function f(i) {
				var e = t(this),
					...
					o = null;
				i.preventDefault(), (o = a.length ? e.closest("[data-wishlist-id]").find(".wishlist-title") : e.parents(".wishlist-title")).next().show().find('input[type="text"]').focus(), o.hide()
			}
			...
			function u(i) {
				var e, a = t(this),
					o = a.closest(".hidden-title-form"),
					n = a.closest("[data-wishlist-id]").data("wishlist-id"),
					s = o.find('input[type="text"]'),
					l = s.val();
				if (i.preventDefault(), !l) return o.addClass("woocommerce-invalid"), void s.focus();
				e = {
					...
					success: function(t) {
						var i = t.fragments;
						t.result ? (o.hide(), o.prev().find(".wishlist-anchor").text(l).end().show()) : (o.addClass("woocommerce-invalid"), s.focus()), void 0 !== i && T(i)
					}
				})
			}
					...
					if (void 0 !== i) {
						...
						if (o.length) {
							...
							s.append(t("<i/>", {
								...
								class: "feedback",
								html: i
							})), s.css("display", "none"), a.css("height", "auto"), o.after(s), o.fadeOut(200, (function() {
								s.fadeIn()
							})), n.addClass("feedback"), n.css("left", t(window).innerWidth() / 2 - n.outerWidth() / 2 + "px"), (void 0 === yith_wcwl_l10n.auto_close_popup || yith_wcwl_l10n.auto_close_popup) && setTimeout(v, yith_wcwl_l10n.popup_timeout)
						}
					} else try {
						t.prettyPhoto.close()
					} catch (t) {}
			...
			function g(i) {
				var e = t("#yith-wcwl-popup-message"),
					...
					o = void 0 !== yith_wcwl_l10n.popup_timeout ? yith_wcwl_l10n.popup_timeout : 3e3;
			...
			function y(i) {
				...
				e.each((function() {
					var e = t(this),
						a = e.find("option"),
						o = a.filter('[value="new"]');
					a.not(o).remove(), t.each(i, (function(i, a) {
						t("<option>", {
							value: a.id,
					...
					var e = t(this),
						a = e.find("li"),
						o = e.closest(".yith-wcwl-add-button").children("a.add_to_wishlist"),
						n = o.attr("data-product-id"),
						s = o.attr("data-product-type");
			...
			function C(i) {
				if (yith_wcwl_l10n.enable_ajax_loading) {
					...
					e && t.ajax({
						...
						method: "post",
						success: function(a) {
							void 0 !== a.fragments && (T(a.fragments), n(), t(document).trigger("yith_wcwl_fragments_loaded", [e, a.fragments, i.firstLoad]))
						},
						url: yith_wcwl_l10n.ajax_url
					})
				}
			...
			function T(i) {
				t.each(i, (function(i, e) {
					var a = "." + i.split(yith_wcwl_l10n.fragments_index_glue).filter(t => t.length && "exists" !== t).join("."),
						o = t(a),
						n = t(e).filter(a);
					n.length || (n = t(e).find(a)), o.length && n.length && o.replaceWith(n)
				}))
			}
			...
			t(document).on("yith_wcwl_init", (function() {
				var S = t(this),
					P = "undefined" != typeof wc_add_to_cart_params && null !== wc_add_to_cart_params ? wc_add_to_cart_params.cart_redirect_after_add : "";
				S.on("click", ".add_to_wishlist", (function(i) {
						var e, a = t(this),
							o = a.attr("data-product-id"),
							s = t(".add-to-wishlist-" + o),
							l = {
								add_to_wishlist: o,
						...
						if (x()) return t.ajax({
							...
							success: function(i) {
								var e = i.result,
									o = i.message;
								yith_wcwl_l10n.multi_wishlist ? (v(o), void 0 !== i.user_wishlists && y(i.user_wishlists)) : g(o), "true" !== e && "exists" !== e || (void 0 !== i.fragments && T(i.fragments), yith_wcwl_l10n.multi_wishlist && !yith_wcwl_l10n.hide_add_button || s.find(".yith-wcwl-add-button").remove(), s.addClass("exists")), n(), t("body").trigger("added_to_wishlist", [a, s])
							}
						}), !1;
						...
						if (void 0 !== a && a.closest(".wishlist_table").length) {
							"undefined" != typeof wc_add_to_cart_params && (wc_add_to_cart_params.cart_redirect_after_add = P), "undefined" != typeof yith_wccl_general && (yith_wccl_general.cart_redirect = P);
					...
					})), S.on("cart_page_refreshed", "body", n), S.on("click", ".show-title-form", f), S.on("click", ".wishlist-title-with-form h2", f), S.on("click", ".remove_from_all_wishlists", (function(i) {
						var e = t(this),
							a = e.attr("data-product-id"),
							o = e.data("wishlist-id"),
							s = e.closest(".content"),
							l = {
						...
						i.preventDefault(), t.ajax({
							...
							method: "post",
							success: function(t) {
								void 0 !== t.fragments && T(t.fragments), n()
							},
							url: yith_wcwl_l10n.ajax_url
						})
						...
						var i = t(this),
							...
							a = e.data("token"),
							o = i.parents("[data-row-id]").data("row-id");
						h({
							wishlist_token: a,
							...
							void 0 !== t.fragments && T(t.fragments), k(e)
						}))
						...
						var i = t(this),
							...
							o = i.closest("form"),
							s = o.find(".wishlist-select").val(),
							l = o.find(".wishlist-name"),
							d = l.val(),
							c = o.find(".wishlist-visibility").filter(":checked").val();
						...
						l.closest("p").removeClass("woocommerce-invalid"), h({
							...
							var e = t.message;
							yith_wcwl_l10n.multi_wishlist ? (v(e), void 0 !== t.user_wishlists && y(t.user_wishlists)) : g(e), void 0 !== t.fragments && T(t.fragments), n(), k(i)
						}))
					})), S.on("click", ".delete_item", (function() {
						var i = t(this),
							e = i.attr("data-product-id"),
							a = i.data("item-id"),
							o = t(".add-to-wishlist-" + e);
						return t.ajax({
							url: yith_wcwl_l10n.ajax_url,
							data: {
							...
							success: function(e) {
								var a = e.fragments,
									s = e.message;
								yith_wcwl_l10n.multi_wishlist && v(s), i.closest(".yith-wcwl-remove-button").length || g(s), void 0 !== a && T(a), n(), t("body").trigger("removed_from_wishlist", [i, o])
							}
						}), !1
						...
						i.is(":checked") ? e.attr("checked", "checked").change() : e.removeAttr("checked").change()
						...
						return t.ajax({
							...
							data: o + "&action=" + yith_wcwl_l10n.actions.ask_an_estimate,
							dataType: "json",
							method: "post",
							success: function(i) {
								if (void 0 !== i.result && i.result) {
									var o = i.template;
									void 0 !== o && (e.replaceWith(o), a.css("height", "auto"), setTimeout(v, yith_wcwl_l10n.time_to_close_prettyphoto))
						...
						t("html, body").animate({
							...
							function(i, e) {
								var a = i.attr("data-product-id"),
									o = t(document).find(".cart.wishlist_table"),
									s = o.data("pagination"),
									l = o.data("per-page"),
									d = o.data("id"),
									c = o.data("token"),
								...
								if (!x()) return void window.alert(yith_wcwl_l10n.labels.cookie_disabled);
								t.ajax({
									type: "POST",
									url: yith_wcwl_l10n.ajax_url,
									data: r,
									...
									success: function(i) {
										var a = t(i),
											o = a.find("#yith-wcwl-form"),
											s = a.find(".yith-wfbt-slider-wrapper");
										e.replaceWith(o), t(".yith-wfbt-slider-wrapper").replaceWith(s), n(), t(document).trigger("yith_wcwl_reload_wishlist_from_frequently")
									}
								})
							}(e, a)
						...
						var a = t(i.target).data("product_id"),
							o = e.variation_id,
							n = t('[data-product-id="' + a + '"]').add('[data-original-product-id="' + a + '"]'),
							s = n.closest(".wishlist-fragment");
						a && o && n.length && (n.each((function() {
							var i, e = t(this),
								n = e.closest(".yith-wcwl-add-to-wishlist");
							e.attr("data-original-product-id", a), e.attr("data-product-id", o), n.length && (void 0 !== (i = n.data("fragment-options")) && (i.product_id = o, n.data("fragment-options", i)), n.removeClass((function(t, i) {
						...
						var e = t(i.target).data("product_id"),
							...
							o = a.closest(".wishlist-fragment");
						e && a.length && (a.each((function() {
							var i, a = t(this),
								o = a.closest(".yith-wcwl-add-to-wishlist"),
								n = a.attr("data-product-id");
							a.attr("data-product-id", e), a.attr("data-original-product-id", ""), o.length && (void 0 !== (i = o.data("fragment-options")) && (i.product_id = e, o.data("fragment-options", i)), o.removeClass("add-to-wishlist-" + n).addClass("add-to-wishlist-" + e).attr("data-fragment-ref", e))
						})), b(o), C({
							fragments: o,
							firstLoad: !1
						}))
					...
					})), S.on("yith_wcwl_fragments_loaded", (function(i, e, a, o) {
						o && t(".variations_form").find(".variations select").last().change()
					...
					function() {
						...
						var e = t(this),
							...
							o = e.data("tab"),
							n = a.find(".tab").filter("." + o);
						if (i.preventDefault(), !n.length) return !1;
						e.addClass("active").siblings(".show-tab").removeClass("active"), n.show().siblings(".tab").hide(), "create" === o ? a.prepend('<input type="hidden" id="new_wishlist_selector" class="wishlist-select" value="new">') : a.find("#new_wishlist_selector").remove()
					...
					function() {
						...
						t(window).on("resize", (function() {
							var e = t(".wishlist_table.responsive"),
								...
								c = {},
								r = !1;
							e.length && (o.matches && e && !a ? (d.is_mobile = "yes", r = !0) : !o.matches && e && a && (d.is_mobile = "no", r = !0), r && (i && i.abort(), c[l.split(" ").join(yith_wcwl_l10n.fragments_index_glue)] = d, i = t.ajax({
								beforeSend: function() {
									b(e)
								},
								complete: function() {
								...
								method: "post",
								success: function(i) {
									void 0 !== i.fragments && (T(i.fragments), n(), t(document).trigger("yith_wcwl_responsive_template", [a, i.fragments]))
								},
								url: yith_wcwl_l10n.ajax_url
							})))
						}))
