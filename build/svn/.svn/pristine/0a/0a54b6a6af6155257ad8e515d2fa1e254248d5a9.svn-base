...
class EO_WBC_Home
{
    ...
    private function eo_wbc_buttons(){ //the two buttons UI
        ...
        return '<div id="wbc_"><p style="font-size: 1.6em;text-align:center;">'.get_option('eo_wbc_home_btn_tagline','Make your own pair from recommandation').'</p></div>'.                
             ...
             '<span class="woocommerce">'.
                ...
                '&STEP=1" style="padding:12px 27px;font-size: 15px;color: #232323;'.            
                  (!get_option('eo_wbc_home_default_button')?$this->eo_wbc_buttons_css():'').'">'.
                    (get_option('eo_wbc_home_btn_text','start with')).' '.get_option('eo_wbc_first_name').
                '</a>'.
             '</span>'.
             '<span style="font-size: 15px;padding-left:1em;padding-right:1em;">OR</span>'.
             '<span class="woocommerce">'.
                 '<a class="checkout-button button alt wc-forward" href="'.
                 get_bloginfo('url').
                 ...
                 '&STEP=1" style="padding:12px 21px;font-size: 15px;color: #232323;'.            
                  (!get_option('eo_wbc_home_default_button')?$this->eo_wbc_buttons_css():'').'">'.
                    (get_option('eo_wbc_home_btn_text','start with')).' '.get_option('eo_wbc_second_name').
                '</a>'.
             '</span>'.
        '</div>'.
        '<style>'.
