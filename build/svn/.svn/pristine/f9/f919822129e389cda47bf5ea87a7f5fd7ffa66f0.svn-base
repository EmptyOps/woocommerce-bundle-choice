...
Any type of bundle can be created. Bundles of products are created that are frequently bought together. It supports every kind of inventory. If you have a jewelry website then this jewelry plugin for WooCommerce will help you create a bundle by building a ring/jewellery. If you have an apparel website then this clothing plugin for WooCommerce will help you suggest pairs.
