    ...
    <form action="" method="post">
        ...
        <table cellspacing="30">            			
        	<tbody>    		
                ...
                <tr>
                    <td class="extra-strong"><?php _e('Customize Filters',"woo-bundle-choice"); ?></td>
                    <td>                    
                        <table cellspacing="30">
                            <tr>                    
                                <td class="strong"><?php _e("Headers","woo-bundle-choice"); ?></td>
                                <td>
                                    <input type="text" name="eo_wbc_filter_config_font_family" value="<?php echo get_option('eo_wbc_filter_config_font_family',''); ?>" style="width: 100%;">
                                    <div class="info">( <?php _e("Font family to be used in filters.","woo-bundle-choice"); ?> )</div>
                                </td>               
                            </tr>
                            <tr>                    
                                <td class="strong"><?php _e("Headers color","woo-bundle-choice"); ?></td>
                                <td>
                                    <input type="color" name="eo_wbc_filter_config_header_color" value="<?php echo get_option('eo_wbc_filter_config_header_color','#4285f4'); ?>" style="width: 100%;">
                                    <div class="info">( <?php _e("Color for headers in filters widget.","woo-bundle-choice"); ?> )</div>
                                </td>               
                            </tr>
                            <tr>                    
                                <td class="strong"><?php _e("Labels color","woo-bundle-choice"); ?></td>
                                <td>
                                    <input type="color" name="eo_wbc_filter_config_label_color" value="<?php echo get_option('eo_wbc_filter_config_label_color','#4285f4'); ?>" style="width: 100%;">
                                    <div class="info">( <?php _e("Color for crumb currently not in use.","woo-bundle-choice"); ?> )</div>
                                </td>               
                            </tr>                       
                            <tr>                    
                                <td class="strong"><?php _e("Slider nodes color","woo-bundle-choice"); ?></td>
                                <td>
                                    <input type="color" name="eo_wbc_filter_config_slidernode_color" value="<?php echo get_option('eo_wbc_filter_config_slidernode_color','#4285f4'); ?>" style="width: 100%;">
                                    <div class="info">( <?php _e("Color for slidable node over sliders.","woo-bundle-choice"); ?> )</div>
                                </td>
                            </tr>               
                            <tr>                    
                                <td class="strong"><?php _e("Slider track color","woo-bundle-choice"); ?></td>
                                <td>                                    
                                    <input type="color" name="eo_wbc_filter_config_slidertrack_color" value="<?php echo get_option('eo_wbc_filter_config_slidertrack_color','#4285f4'); ?>" style="width: 100%;">
