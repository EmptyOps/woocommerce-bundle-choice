...
We have tested WooCommerce Product Bundle Choice with Wordpress 3.5 to 5.2.3 and WooCommerce 2.0 to 3.7.0 and our plugin is technically compatible with all the other plugins.
...
= With which WordPress version this Plugin is compatible? =
  It is compatible from 3.5 to 5.2.3 WordPress version.
