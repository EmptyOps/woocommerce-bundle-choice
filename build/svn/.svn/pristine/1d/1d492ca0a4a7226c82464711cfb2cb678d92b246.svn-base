                                                              ...
                                                              <div class="ui dimmer">
                                                                <div class="content">
                                                                  <div class="bottom">
                                                                    ...
                                                                    <div data-link="<?php echo $this->eo_wbc_product_url(get_permalink($_post->ID)); ?>" class="ui inverted button"><?php echo  get_option('eo_wbc_add_to_cart_text',__('View ','woo-bundle-choice')) ;?></div>
