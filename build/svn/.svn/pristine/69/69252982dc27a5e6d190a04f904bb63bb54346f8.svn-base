...
Allows you to create product bundles in almost any inventory - Ring builder for Jewelry, Pair Maker for Clothing, grocery or any other, Guidance tool for Home Decor, Cosmetics etc. create Bundles and sell more.

== Description ==
You can create product bundles with the following features:
1. Ring Builder
2. Pair Maker
3. Additionally, you can have Rapnet instant inventory integration if you have a jewellery/diamond website.
 
Any type of bundle can be created. Bundles of products are created that are frequently bought together. It supports every kind of inventory. If you have a jewellery website then this jewellery plugin for WooCommerce will help you create a bundle by building a ring/jewellery. If you have an apparel website then this clothing plugin for WooCommerce will help you suggest pairs.
In short, you can create apparel bundles, enable ring builder feature and create use your creativity and create your own style of bundles.

= 1. Ring Builder =
Not only ring but it is also for pendant/necklace, bracelet or nose-ring etc. For example, you are selling jewellery online. Then the customer step by step creates a pair of - firstly ring setting/mount, then diamond and so on. This way pair of different parts creates a complete product or pattern. [See a Demo](http://cvddiamond.xyz/product-category/solitaire/?EO_WBC=1&BEGIN=solitaire&STEP=1)

= 2. Pair Maker =
For example, you are selling clothes online then the customer after selecting top-wear will be guided for the bottom wear automatically. So if by chances user is confused then they will be guided making a right pair and thus bundle of clothing is created. [See a Demo](http://101.53.136.134/demo/yc_textile/)

= 3. Additional Feature =
To enable Rapnet instant inventory integration please install this free plugin and go to 'extensions' tab in the admin page of Wordpress, there you will find Rapnet Integration extension. This WooCommerce Rapnet plugin/extension will allow you to easily enable pulling and displaying of diamond feeds on your jewellery/diamond websites from Rapnet instant inventory.
...
* Easy to Install.
* Lightning ready.
* Product Bundle is possible by the visitor of the website.
* Enables skilled production which leads to good results.
* Supports every inventory
* Mix and Match Products through Product Bundle
