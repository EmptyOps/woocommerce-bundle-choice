                        ...
                        if($('#main').length){
                          ...
                          if( $(".post-content").length ){
                            ...
                            if( $("#content,.content").length ){
                              ...
                              eo_wbc_outer_container=$('#content,.content')[0];
