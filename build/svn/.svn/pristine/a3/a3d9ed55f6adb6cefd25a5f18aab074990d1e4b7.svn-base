                                ...
                                if( is_array($_posts) && !empty($_posts) ){
                                    ...
                                    foreach ($_posts as $_post) {                                        
                                        ...
                                        if(!empty($prev_product && $curr_product)) {
                                            ...
                                            ?>                                      
                                            <a href="<?php echo $this->eo_wbc_product_url(get_permalink($_post->ID)); ?>" class="cat_products seven wide column">
                                                    ...
                                                    <div class="ui special cards">
                                                        <div class="card">
                                                            <div class="blurring dimmable image">
                                                              ...
                                                              <img src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id($_post->ID),'full')[0]; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="card">
                                                            <div class="blurring dimmable image">
                                                              ...
                                                              <img src="<?php echo wp_get_attachment_image_src( get_post_thumbnail_id($prev_product_id),'full')[0]; ?>">
                                                            </div>
                                                        </div>
                                                    </div>                                                  
