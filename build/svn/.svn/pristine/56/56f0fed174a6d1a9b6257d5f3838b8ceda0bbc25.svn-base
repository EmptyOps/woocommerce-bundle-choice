...
This plugin allows users to bundle(choose) their choice based on recommendations set by admin by use of product categories.
...
This plugin allows users to dynamically create their own assortments, by mixing and matching products. 
...
[youtube https://www.youtube.com/watch?v=vIJp31cXruo]
