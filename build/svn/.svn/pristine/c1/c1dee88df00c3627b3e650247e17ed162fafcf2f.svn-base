...
We have tested WooCommerce Product Bundle Choice with Wordpress 3.5 to 5.2.2 and WooCommerce 2.0 to 3.6.5 and our plugin is technically compatible with all the other plugins.
