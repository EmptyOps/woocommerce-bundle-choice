...
class EO_WBC_Choice{   
    ...
    public function eo_wbc_admin(){                               
            ...
            add_action('admin_notices',function (){
                ...
                ?><div class='notice notice-error is-dismissible'> 
                    ...
                    /* translators: %5$s: reporting </a> ends */
                     printf( __('%1$s WooCommerce Bundle Choice %2$s have noticed %3$s plugin errors, would you like to have a look or %4$s report to the support. %5$s', 'woo-bundle-choice' ),"<strong>","</strong>", get_option('eo_wbc_error_report',0) , "<a href='".admin_url('admin.php?page=eo-wbc-logs')."'>" , "</a>");
                    ?>
                        </p>
                    </div>
                <?php                
        ...
        if(get_option('eo_wbc_mapping_error_report',false)){
            ...
            add_action('admin_notices',function (){
                ...
                <div class='notice notice-error'>
                    <p> 
                        ...
                        /* translators: %1$s: <strong> tag */
                        /* translators: %2$s: </strong> tag */       
                        printf( __('%1$s WooCommerce Bundle Choice %2$s has been reported mapping issue at this <a href="'.get_option('eo_wbc_mapping_error_report').'" target="_blank">link.</a>','woo-bundle-choice') , "<strong>","</strong>")
                        ?>
                    </p>
                </div>
                <?php
            ...
            delete_option('eo_wbc_mapping_error_report');
        }
    ...
    public function eo_wbc_frontend() {          
        ...
        if(
            ...
            add_action('template_redirect',function(){
                ...
                if( function_exists('wc') && !empty(wc()->session) && function_exists('is_user_logged_in') && !is_user_logged_in() )
                {                   
