...
<h1></h1>
  ...
  <br/>
	...
	<div style="float: right;">
		...
		<input type="submit" value="Send error report" class="submit button-primary" name="report" onclick="window.location.href='<?php echo admin_url('admin.php?page=eo-wbc-logs&eo_wbc_view_error=1&action=report'); ?>'">	
		<br/><br/>
