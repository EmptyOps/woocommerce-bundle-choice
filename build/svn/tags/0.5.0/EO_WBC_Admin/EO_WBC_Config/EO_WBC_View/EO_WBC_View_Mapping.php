            ...
            <table class="fixed">
                <tbody>                
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="radio" name="attr_pref" value="and" <?php echo get_option('eo_wbc_map_attr_pref','or')==='and'?'checked="checked"':''; ?> >&nbsp;&nbsp;And
                            &nbsp;
                            <input type="radio" name="attr_pref" value="or" <?php echo get_option('eo_wbc_map_attr_pref','or')==='or'?'checked="checked"':''; ?> >&nbsp;&nbsp;Or
                        </td>                    
                        <td>&nbsp;</td>
                     </tr>                 
                    <tr>
