    	...
    	<tbody>
            ...
            <tr>               
                <td>
                    <hr/>
                    <fieldset>
                        <legend>Make Pair Button Configuration</legend>
                        <span class="info">( Configure make pair button available on product page. )</span>
                        <hr/>
                        <table>
                            <tr>
                                ...
                                <td>                                    
                                    ...
                                    <span class="info">( Check here to show make pair button on product pages. )</span>
                                    <br/><br/>
                                </td>                        
                            </tr>                            
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="info">( Text that will be displayed on button. )</span>
                                </td>
                            </tr>                        
                        </table>
                    </fieldset>                    
                    ...
                    <fieldset>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class='info'> ( Icon to be shown on breadcrumb. )</span>
                            </td>
                        </tr>
                    </table>
                    </fieldset>    				
