...
class EO_WBC_Review
{
    ...
    public function change_price($price,$id){
        error_log($price);
        error_log(gettype($price));
        return $price."X1";
