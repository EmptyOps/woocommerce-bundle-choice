			...
			<div class="addons-banner-block-items">
				<div class="addons-banner-block-item">
					...
					<div class="addons-banner-block-item-content">
						...
						<p>Let customers browse your inventory in tabular view, which is handy tool for diamond industry, <a target="_blank" href="http://cvddiamond.xyz/product-category/solitaire/?EO_WBC=1&BEGIN=solitaire&STEP=1&EO_WBC_CODE=cmdiKDUxLCA1MSwgNTEpL3JnYigzNSwgMzUsIDM1KQ==">Click here for demo.</a> </p>
