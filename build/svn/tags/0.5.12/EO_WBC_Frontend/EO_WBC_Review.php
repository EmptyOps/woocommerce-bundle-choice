    ...
    {   
        ...
        add_filter('the_content',function(){
            ...
            if(!empty($set)){
                ...
                echo EO_WBC_Breadcrumb::eo_wbc_add_breadcrumb(sanitize_text_field($_GET['STEP']),sanitize_text_field($_GET['BEGIN'])).'<br/>';
                ?>
                    ...
                    <div class="card">
                        <div class="blurring dimmable image">
                          <div class="ui dimmer inverted transition hidden">
                            <div class="content">
                                <div class="center">
                                    <a class="ui button primary" href="<?php  echo get_bloginfo('url').get_option('eo_wbc_first_url').
                        ...
                        <div class="content">
                            <div class="header"><?php _e($first->get_title()); ?></div>
                            <div class="meta">
                                <?php _e($set['FIRST'][2]?"<br/>".implode('<br/>',EO_WBC_Support::eo_wbc_get_product_variation_attributes($set['FIRST'][2])):''); ?>
                            </div>
                        </div>
                        <div class="extra content">                            
                            <div class="header description">
                                <?php echo ($first->get_price_html()."&nbsp;X&nbsp;".$set['FIRST'][1]); ?>
                            </div>
                        </div>                    
                    </div>                   
                    <div class="card">
                          ...
                          <div class="ui dimmer inverted transition hidden">
                            <div class="content">   
                                <div class="center">
                                    ...
                                    href="<?php echo get_bloginfo('url').get_option('eo_wbc_second_url').
                '?EO_WBC=1&BEGIN='.sanitize_text_field(empty($_GET['BEGIN'])?'':$_GET['BEGIN']).
                '&STEP=1'.
                ...
                '&EO_CHANGE=1'; ?>">Change</a>        
                        ...
                        <div class="content">
                            <div class="header"><?php _e($second->get_title()); ?></div>
                            <div class="meta">
                                <?php _e($set['SECOND'][2]?"<br/>".implode('<br/>',EO_WBC_Support::eo_wbc_get_product_variation_attributes($set['SECOND'][2])):''); ?>
                                
                            </div>                            
                        </div>
                        <div class="extra content">
                            <div class="header description">
                                <?php echo ($second->get_price_html()."&nbsp;X&nbsp;".$set['SECOND'][1]); ?>
                            </div>
                        </div>                                      
                    </div>
                </div>
                <form action="" method="post" class="woocommerce" style="float:right;">
                    ...
                    <button class="checkout-button button alt wc-forward" style="margin: 2em 0px;"><?php _e('Add This To Cart','woo-bundle-choice'); ?>                        
                    </button>
                </form>
                <style>@media only screen and (max-width: 600px) {.checkout-button.button.alt.wc-forward{ display:grid;position: relative;margin: auto; } }.woocommerce div.product .product_title{ font-size: 1em !important;}</style>
