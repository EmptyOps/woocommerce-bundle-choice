...
{   
    ...
    function menu() {
        ...
        add_action('admin_menu',function(){
            ...
            //Personalize
            add_submenu_page('eo-wbc-home', __('Personalize','woo-bundle-choice'), __('Personalize','woo-bundle-choice'), 'administrator', 'eo-wbc-personalize',array($this,'eo_wbc_personalize'));           
            $this->menu_slugs['Personalize']='eo-wbc-personalize';
    ...
    function eo_wbc_logs(){
        /*require_once apply_filters('eo_wbc_admin_config_filter_logs','EO_WBC_View/EO_WBC_View_Logs.php');*/   
    }
}