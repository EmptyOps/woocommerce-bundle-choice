    ...
    public function eo_wbc_admin(){
        ...
        if(!empty(get_option('eo_wbc_error_report',0))){
            add_action('admin_notices',function (){
                ...
                echo "<div class='notice notice-error is-dismissible'><p>".__( '<strong>Woo Bundle Choice</strong> have noticed '.get_option('eo_wbc_error_report',0).' plugin errors, would you like to have a <a href="'.admin_url('admin.php?page=eo-wbc-home&eo_wbc_view_error=1').'">look or report to the support</a>.', 'woocommerce' )."</p></div>";
            },15);
        }
