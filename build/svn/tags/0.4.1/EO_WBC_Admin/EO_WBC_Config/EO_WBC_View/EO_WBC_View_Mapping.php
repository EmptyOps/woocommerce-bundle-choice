...
<div class="wrap woocommerce">
    ...
    <form action="<?php echo admin_url('admin.php?page=eo-wbc-map'); ?>" method="post">
        ...
        <fieldset style="border: 1px solid black;border-radius: 2px;width: fit-content;padding: 1.5em;">
            <legend><h3>Product mapping preference</h3></legend>
            <p class="info">( Determine how the product mapping shoul behave.<br/> eg: AND - product belongs to both category/attribute A and B<br/> OR - product belongs to either of category/attribute A or B )</p>                        
            <table class="fixed">
                <tbody>                
                    <tr>
                        <td style="width: 10em;vertical-align: text-top;">Category</td>
                        <td>
                            <input type="radio" name="cat_pref" value="and" <?php echo get_option('eo_wbc_map_cat_pref','and')==='and'?'checked="checked"':''; ?> >&nbsp;&nbsp;And
                            &nbsp;
                            <input type="radio" name="cat_pref" value="or" <?php echo get_option('eo_wbc_map_cat_pref','and')==='or'?'checked="checked"':''; ?>>&nbsp;&nbsp;Or                            
                            <br/><br/>
                        </td>
                        <td>&nbsp;</td>                        
                    </tr>
                    <tr>
                        <td style="width: 10em;vertical-align: text-top;">Attribute</td>
                        <td>
                            <input type="radio" name="attr_pref" value="and" <?php echo get_option('eo_wbc_map_attr_pref','and')==='and'?'checked="checked"':''; ?> >&nbsp;&nbsp;And
                            &nbsp;
                            <input type="radio" name="attr_pref" value="or" <?php echo get_option('eo_wbc_map_attr_pref','and')==='or'?'checked="checked"':''; ?> >&nbsp;&nbsp;Or
                        </td>                    
                        <td>&nbsp;</td>
                     </tr>                 
                    <tr>
                        <td class="manage-column column-columnname num" scope="col" colspan="3">
                            <br/>
                            <button class="button button-primary action" style="float: right">Save Preference</button>
                        </td>            
                     </tr>
                 </tbody>
           </table>    
    ...
    <fieldset style="border: 1px solid black;border-radius: 2px;width: fit-content;padding: 1.5em;">
        <legend><h3>Map creation and modification</h3></legend>
