...
{   
    ...
    function admin_actions(){
        ...
        //add_action( 'save_post_product',array($this,'jpc_update')); 
        /*add_action( 'added_post_meta',array($this,'jpc_update_meta')); 
        add_action( 'updated_post_meta',array($this,'jpc_update_meta'));*/        
