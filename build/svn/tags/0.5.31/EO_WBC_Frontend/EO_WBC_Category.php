            ...
            $html.='<div class="woocommerce ui grid centered">';
                $html.='<div class="ui row" style="height:max-content;">';                    
                    $html.="<div class='ui grid centered'>";
                        ...
                        $html.="</div>";    
                        $html.="<div class='ui row'  style='padding-bottom:3rem !important'>";                            
                            $html.='<a href="'.$this->eo_wbc_prev_url().'" class="ui inverted secondary single_add_to_cart_button button alt">Go back</a>&nbsp;&nbsp;';
                            $html.='<a href="'.((empty($_GET['FIRST']) XOR empty($_GET['SECOND']))?strtok(get_permalink((empty($_GET['FIRST'])?$_GET['SECOND']:$_GET['FIRST'])),'?'):'').'" class="ui grey button single_add_to_cart_button alt">Continue buying single item</a>&nbsp;&nbsp;';
                        $html.="</div>";    
