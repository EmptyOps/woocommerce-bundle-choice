...
<h1></h1>
  ...
  <br/>
	...
	<br/>
	<input type="checkbox" name="agree_terms" id="agree_terms" onchange="if(jQuery(this)[0].checked){ jQuery('#send_report').removeClass('disabled'); } else { jQuery('#send_report').addClass('disabled'); }">
	<label for="agree_terms"> I agree with sphereplugin's <a href="https://sphereplugins.com/terms-conditions/">Terms & Policy</a>.</label>
	<br/>
	<br/>
