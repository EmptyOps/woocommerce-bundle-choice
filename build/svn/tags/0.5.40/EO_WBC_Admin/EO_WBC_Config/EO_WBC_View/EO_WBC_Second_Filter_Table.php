	...
	class EO_WBC_Second_Filter_Table extends WP_List_Table{
		...
		function column_cb($item) {
			...
			$actions = array(
		        ...
		        'delete'    => sprintf('<a href="?page=%s&action=%s&name=%s&eo_wbc_action=%s&eo_filter_target=%s">'.__('Delete',"woo-bundle-choice").'</a>',$_REQUEST['page'],'delete',$item['id'],'single_filter_delete','eo_wbc_add_filter_second'),		        
		    );
