    	...
    	<tbody>
            ...
            <tr>
                <td>
                    ...
                    <span class="info">( Set custome position of choice buttons. )</span>
                </td>
                <td>
                    <table cellspacing="30">
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="info">( Choose type of setup.<br/>&nbsp;Default : non-technical users.<br/>&nbsp;Shortcode : expert users only. )</span>
                            </td>
                        </tr>
                        <tr class="eo_wbc_btn_setting_page_toggle">
                            <td>
                                <strong>Page</strong>
                            </td>
                            <td>
                                <select name='eo_wbc_btn_page' style="width: 100%;">
                                    <?php 
                                        $home_page_id=get_option('page_on_front');                                         
                                        foreach (eo_wbc_admin_page_lists() as $page)
                                        {
                                            if(!$home_page_id){
                                                $home_page_slug=eo_wbc_admin_page_lists()[0]->post_name;
                                            }
                                            elseif ($home_page_id==$page->ID) {
                                                $home_page_slug=$page->post_name;
                                            }
                                            echo "<option data-id='".$page->ID."' value='".$page->post_name."'>".$page->post_title."</option>";                                           
                                        }
                                    ?>
                                </select>
                                <span class="info">( Page to display buttons. )</span>
                            </td>
                        </tr>
                        <tr class="eo_wbc_btn_setting_position_toggle">
                            ...
                            <td>
                                ...
                                <span class="info">( Position of buttons on page. )</span>                    
                                <div class="eo_wbc_position_toggle" hidden="hidden" >
                                    <br/>      
                                    <input required="required" type="number" name="eo_wbc_btn_custome_after" style="width: 100%;" placeholder="count of elements before buttons" step="1" min="0" value="<?php echo get_option('eo_wbc_btn_custome_after')?get_option('eo_wbc_btn_custome_after'):1; ?>">
                                    <span class="info">( Buttons just before given number of element. )</span>                    
                                </div>
                            </td>
                        </tr>                        
                    </table>
...
<script type="text/javascript">	
    ...
    jQuery(document).ready(function($){
        ...
        $("[name='eo_wbc_btn_page']").val("<?php echo get_option('eo_wbc_btn_page')?get_option('eo_wbc_btn_page'):$home_page_slug; ?>");

        //function to toggle textbox which indicates position of buttons in container.
        function toggle_btn_position(){
            if($("[name='eo_wbc_btn_position']").val()=='custome'){
        ...
        //function to handle on change of page positon if value is "custome".
