    ...
    private function eo_wbc_render()
    {
        ...
        add_action('woocommerce_before_cart_contents',function(){
            ...
            add_action('woocommerce_after_cart_table',function(){
                echo '<div style="float:right;"><a href="'.(get_option('eo_wbc_btn_setting')?get_bloginfo('url').'/'.get_option('eo_wbc_btn_page'):get_bloginfo('url')).'" class="checkout-button button alt wc-backword">Continue Shopping</a>
