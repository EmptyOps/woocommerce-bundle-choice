...
add_action('plugins_loaded',function(){   
    ...
    add_action( 'wp_enqueue_scripts',function(){
        ...
        wp_register_style( 'eo-wbc-ui',plugin_dir_url(__FILE__).'css/fomantic/semantic.min.css');
        wp_enqueue_style( 'eo-wbc-ui');      

        wp_register_script( 'eo-wbc-ui',plugin_dir_url(__FILE__).'js/fomantic/semantic.min.js');
    ...
    ?>
        <script type="text/javascript">
            jQuery(document).ready(function($){
                once_more=function(){
                    $.get('<?php echo admin_url('admin-ajax.php')?>',{action:'eowbc_search_product',term:'heart',security:'<?php echo wp_create_nonce('eowbc_search_product'); ?>'},function(data){
                    console.log(data);
                    });
                }
