<?php
/** 
* Plugin Name: WooCommerce Product Bundle Choice
...
add_action('plugins_loaded',function(){
    ...
    add_action( 'wp_enqueue_scripts',function(){
        wp_register_style( 'eo-wbc-step-style',plugin_dir_url(__FILE__).'css/step.min.css');
        wp_enqueue_style( 'eo-wbc-step-style' );
        ...
        wp_register_style( 'eo-wbc-header-style',plugin_dir_url(__FILE__).'css/header.min.css');
        wp_enqueue_style( 'eo-wbc-header-style' );
