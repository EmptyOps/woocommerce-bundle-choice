...
We also have Rapnet Extension, read more about it below in the Extensions section{here link with hashtag if avaiable}.
...
== Upgrade Notice ==
= 0.5.35 (Dec 4, 2019) =
  Cretical bug fixed and ui enhancement at customizer page.
= 0.5.34 (Dec 3, 2019) =
  Admin- appearence.
= 0.5.32 (Dec 2, 2019) =
  Customizer based button location determination.
= 0.5.31 (Nov 27, 2019) =
  UI/Backend bugs fixes.
= 0.5.29 (Nov 25, 2019) =
  Add mapping by product name.
= 0.5.28 (Nov 23, 2019) =
  UI bug fix
= 0.5.27 (Nov 19, 2019) =
  UI bug fix and product not found fixup.
= 0.5.26 (Nov 15, 2019) =
  Added new price control system for jewellary users
= 0.5.25 (Nov 09, 2019) =
