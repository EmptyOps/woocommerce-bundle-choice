  ...
  <br/>
	...
	<div style="clear:both;"></div>
	    ...
	    <div class="eo_wbc_action" >	    	
            ...
            <br/><br/>
            <blockquote><?php _e("It will redirect to buttons widget on home, if you have used shortcode than find it on particular page yourself.","woo-bundle-choice");?></blockquote>
	    		</div>
	    	</span>
	    	<?php endif;?>
	    </div>
