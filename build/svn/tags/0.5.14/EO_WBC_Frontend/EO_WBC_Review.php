        ...
        add_filter('the_content',function(){
            ...
            if(!empty($set)){
                ...
                '<form action="" method="post" class="woocommerce" style="float:right;">'.
                    ...
                    '<button class="checkout-button button alt wc-forward" style="margin: 2em 0px;">'.__('Add This To Cart','woo-bundle-choice').
                    '</button>'.
                '</form>'.
                '<style>@media only screen and (max-width: 600px) {.checkout-button.button.alt.wc-forward{ display:grid;position: relative;margin: auto; } }.woocommerce div.product .product_title{ font-size: 1em !important;}'.$this->eo_wbc_buttons_css().'</style>';
                return $content;
            } else {
