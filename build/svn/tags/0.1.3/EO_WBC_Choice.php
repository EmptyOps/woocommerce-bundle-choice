...
{   
    ...
    public function eo_wbc_admin(){
        ...
        require_once apply_filters('eo_wbc_admin_support','EO_WBC_Admin/EO_WBC_Support.php');
    ...
    {          
        if(get_option('eo_wbc_config_category')=="1" && get_option('eo_wbc_config_map')=="1"){
            ...
            add_action('template_redirect',function(){
                ...
                require_once apply_filters('eo_wbc_front_support','EO_WBC_Frontend/EO_WBC_Support.php');
