...
class EO_WBC_Filter_Widget {
	...
	private function get_widget() {
		...
		if( !empty($adv_ordered_filter) ){
			...
			echo "<div class='eo_wbc_advance_filter' style='margin-bottom:1.5em;'><h1 style='text-align:center;background-color: #f5f5f5a6 !important;'><a href='#' style='color:#757171'>".__('Advance Filter',"woo-bundle-choice")."</a></h1><div class='eo_wbc_advance_filter_display' style=''>";
