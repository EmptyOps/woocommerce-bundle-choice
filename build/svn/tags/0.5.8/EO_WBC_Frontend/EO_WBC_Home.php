...
class EO_WBC_Home
{
  ...
  private function eo_wbc_buttons(){ //the two buttons UI
        ...
        return '<div id="wbc_"><p style="font-size: 1.6em;text-align:center;">'.get_option('eo_wbc_home_btn_tagline',__('Make your own pair from recommendation','woo-bundle-choice')).'</p></div>'.
        '<div class="eo_button_container woocommerce">'.
          '<span>'.
            '<a class="checkout-button button alt wc-forward" href="'.
              ...
              '&STEP=1" style="margin:0.33em;font-size: 1em;height:auto;'.            
