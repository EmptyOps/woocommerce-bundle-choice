                ...
                <td>
                    <fieldset>
                        ...
                        <table>
                            ...
                            <tr>
                                <td></td>
                                <td><a class='button button-primary primary' style="float: right;" href="<?php  echo admin_url('admin.php?page=eo-wbc-home&eo_wbc_view_auto_jewel=1'); ?>">Automated Setup</a></td>
                            </tr>          
                        </table>
                    </fieldset>                    
                </td>                
