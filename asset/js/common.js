    ...
    /*#*/zoom_area_hover_in_private(type) {
        ...
        if (splugins.tmpl_lib.is_template_exists(template_id, templating_lib)) {
            ...
            if (hover_media_index !== null) {
                ...
                window.document.splugins.events.api.notifyAllObservers('gallery_images_feed_page', 'zoom_area_hover_in', {
                    type: images[hover_media_index].extra_params_org.type,
                    ...
                    , image: images[hover_media_index], container: super.get_zoom_container()
                }, zoom_area_hover_in_callback, super.get_base_container());
            }
