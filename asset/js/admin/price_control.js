    ...
    if(!jQuery.isEmptyObject(window.eo_wbc.jpc_data)) {
        ...
        jQuery.each(eo_wbc.jpc_data,function(i,e){                        
            if(e.length>=2){
                ...
                jQuery("#jpc_price_ctl_table tbody").append("<tr><td class='center aligned'><a href='#'><i class='ui icon delete'></i></a></td><td class='left aligned'>Regular Price:"+e[e.length-1]['regular_price']+"<br/>"+(e[e.length-1]['sales_price']!=''?'Sales Price:'+e[e.length-1]['sales_price']:'')+'<br/>'+(e[e.length-1]['ratio_price']!=''?'Rational Price:'+e[e.length-1]['ratio_price']:'')+"</td><td class='center aligned'>"+rows_data+"</td></tr>");
            }
        });
