<?php
$json_encode_configs_json_encode = json_encode($configs);
$inline_script =
  ...
  "};\n" .
  "\n" .
  "window.document.splugins.common.admin.form_builder.api = window.document.splugins.common.admin.form_builder.core( window.document.splugins.common.parseJSON( '".$json_encode_configs_json_encode."', false ) );\n"; 
