...
?>
    <style type="text/css">
        body p.name.product-title.woocommerce-loop-product__title{visibility:hidden}.row.category-page-row>.col.large-3{display:none!important}.row.category-page-row>.col.large-9{max-width:100%!important;min-width:100%!important}
