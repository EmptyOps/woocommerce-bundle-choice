<?php    
function yc_admin_config_category_options()
{
    return  get_categories(array(
        ...
        $cat_name=array();
        $cat_slug=array(); 
        $categories=yc_admin_config_category_options();
    			...
    			<td>
    				<table cellspacing="30">
    					<tr>    				
    						...
    						<td>
	    						<select name='yc_first_name' onChange="nameChanged('first',this)" style="width: 100%;">
    							<?php 
    					...
    					<tr>
    						...
    						<td>
  								<select name='yc_first_slug' onChange="slug2url('first',this)" style="width: 100%;">
            						<?php 
    					...
    					<tr>
    						...
    						<td>
  								<div><input type="text" width="100%" size=50 placeholder="relative url of first product" 
    									name="yc_first_url" value="<?php echo get_option("yc_first_url") ?>"></div>    									
    			...
    			<td>
        			<table cellspacing="30">
        					<tr>    				
        						...
        						<td>
    	    						<select name='yc_second_name' onChange="nameChanged('second',this)" style="width: 100%;">
                						<?php 
                                            foreach ($cat_name as $name)
                                            {
                                                echo "<option name='".$name."'>".$name."</option>";
        					...
        					<tr>
        						...
        						<td>
      								<select name='yc_second_slug' onChange="slug2url('second',this)" style="width: 100%;">
                						<?php 
                                            foreach ($cat_slug as $slug)
                                            {
                                                echo "<option name='".$slug."'>".$slug."</option>";
        					...
        					<tr>
        						...
        						<td>
      								<div><input type="text" width="100%" size=50 placeholder="relative url of second product" 
    									name="yc_second_url" value="<?php echo get_option("yc_second_url") ?>"></div>    							
    			...
    			<td>
    				<table cellspacing="30">
        					<tr>    				
        						<td><strong>Name</strong></td>
        						<td>
    	    						<input type="text" name="title_step_three" value="<?php
                            					if($_POST)
                            					{
                            					    echo $_POST['title_step_three'];
                            					}
                            					else {
                            					    echo get_option('yc_collaction_title')?get_option('yc_collaction_title'):"Preview";
                            					}					          					
...
<script type="text/javascript">	
	<?php 
	   ...
	   echo "document.getElementsByName('yc_first_name')[0].value='".get_option('yc_first_name')."';";
	   echo "document.getElementsByName('yc_first_slug')[0].value='".get_option('yc_first_slug')."';";
	   echo "document.getElementsByName('yc_first_url')[0].value='".get_option('yc_first_url')."';";
	   echo "document.getElementsByName('yc_second_name')[0].value='".get_option('yc_second_name')."';";
	   echo "document.getElementsByName('yc_second_slug')[0].value='".get_option('yc_second_slug')."';";
	   echo "document.getElementsByName('yc_second_url')[0].value='".get_option('yc_second_url')."';";
	...
	function slug2url(option,element)
	{
		if(element.value.trim().length>0){
			var target=document.getElementsByName("yc_"+option.trim()+"_url")[0];
			target.value="";
	...
	{				
		document.getElementsByName("yc_"+option.trim()+"_slug")[0].value=category[element.value];
		document.getElementsByName("yc_"+option.trim()+"_slug")[0].onchange();
	}
</script>	