...
<h1></h1>
	...
	<div style="clear:both;"></div>
	    ...
	    <?php 
	       $config_status=get_option('yc_config_category');
	       $map_status=get_option('yc_config_map');
	    ...
	    <div class="breadcrumb">
	    	<a class="breadcrumb__step <?php echo $bar_request==0 ? 'breadcrumb__step--active--2':'breadcrumb__step--active'; ?>" href="<?php echo admin_url( 'admin.php?page=yc-home&bar=0' ); ?>">
	    			<strong>Select Two Categories</strong>
			</a>	    	
	    	<a class="breadcrumb__step <?php echo ($bar_request==1) ? 'breadcrumb__step--active--2':($bar_request<1?'':($bar_request>=1?'breadcrumb__step--active':'')) ?>" href="<?php echo $map_status?admin_url('admin.php?page=yc-home&bar=1'):'#'; ?>">
	    	...
	    	<a class="breadcrumb__step <?php echo ($bar_request==2) ?'breadcrumb__step--active--2':($bar_request<2?'':($bar_request>=2?'breadcrumb__step--active':'')); ?>" 
	    					href="<?php echo ($config_status && $map_status)?admin_url('admin.php?page=yc-home&bar=2'):'#'; ?>">
	    			<strong>Done</strong>
	    	</a>
	    </div>
	    <br/>
	    ...
	    <div class="yc_action" >	    	
	    	...
	    	<span class="info">
	    		...
	    		<br/>
	    		<br/>
	    		<div style="text-align: center;"><a href="<?php echo admin_url( 'admin.php?page=yc-setting&callback=1'); ?>" class="button button-primary button-hero action">Select Two Categories</a></div>
	    	</span>
	    	...
	    	<span class="info">
	    		...
	    		<br/>
	    		<br/>
	    		<div style="text-align: center;"><a href="<?php echo admin_url( 'admin.php?page=yc-map&callback=1' ); ?>" class="button button-primary button-hero action">Map Categories.</a></div>
	    	</span>
	    	...
	    	<span class="info">
	    		...
	    		<br/>
	    		<br/>
	    		<div style="text-align: center;"><a href="<?php echo bloginfo('url').'?#wbc_' ?>" class="button button-primary button-hero action">Let's check it out</a></div>
	    	</span>
	    	<?php endif;?>
	    </div>
</div>
