...
class YC_Support
{
    ...
    public static function wc_get_product_variation_attributes( $variation_id ) {
        return function_exists('wc_get_product_variation_attributes')
                        ?
                            wc_get_product_variation_attributes($variation_id)
                            :
                            self::yc_get_product_variation_attributes($variation_id);
    }
    
    private static function yc_get_product_variation_attributes( $variation_id ) {
