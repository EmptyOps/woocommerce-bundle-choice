...
class SP_WBC_Breadcrumb
{
    ...
    public static function eo_wbc_add_breadcrumb($step=1,$begin){
        ...
        $model_category_attribute = \eo\wbc\model\SP_WBC_Category_Attribute::instance();
        ...
        self::$first_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link(self::$first_slug);
        if(!empty(self::$first_url)){
            self::$first_url=self::$first_url.'EO_WBC=1&BEGIN='.self::$first_slug.'&STEP=1&FIRST=&SECOND=';
        }

        self::$second_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link(self::$second_slug);
    ...
    public static function eo_wbc_breadcrumb_change_url($order,$product_id){        
        ...
        if ($order==1) {
            if(self::eo_wbc_breadcrumb_get_category($chage_product_id)==self::$first_slug/*get_option('eo_wbc_first_slug')*/){
                ...
                $first_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link(self::$first_slug);
            ...
            elseif (self::eo_wbc_breadcrumb_get_category($chage_product_id)==self::$second_slug/*get_option('eo_wbc_second_slug')*/) {
                ...
                $second_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link(self::$second_slug);
