...
class SP_Model_Feed extends SP_Feed {
	...
	public function render_gallery_images_template_callback($args = array()){
        ...
        $ui_definition = $this->ui_appearence_controls_definition(null,'sp_variations_loop_gallery_images_container',array());
        $ui_definition = $this->ui_configuration_controls_definition($ui_definition,'sp_variations_loop_gallery_images_container',array());
        $ui_definition = $this->ui_data_controls_definition($ui_definition, 'sp_variations_loop_gallery_images_container',array());
