...
use eo\wbc\system\core\publics\SP_WBC_Single_Product;

class SP_WBC_Model_Single_Product extends SP_WBC_Single_Product {
	...
	public function render_gallery_images_template_callback($args = array()){
		...
		// ACTIVE_TODO_OC_END*/
		// $data = \eo\wbc\model\publics\SP_WBC_Model_Single_Product::instance()->get_data('gallery_images');
