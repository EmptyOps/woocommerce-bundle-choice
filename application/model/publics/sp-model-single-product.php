...
class SP_Model_Single_Product extends SP_Single_Product {
	...
	public function prepare_load_asset_data( $args = array() ) {
		...
		$data['product_page_css_patch'] = \eo\wbc\model\SP_WBC_Compatibility::instance()->single_product_render_compatability('product_page_css_patch');
	...
	public function render_gallery_images_template_callback($args = array()){
        ...
        $ui_definition = $this->ui_appearence_controls_definition(null,'sp_variations_gallery_images_container',array());
        $ui_definition = $this->ui_configuration_controls_definition($ui_definition,'sp_variations_gallery_images_container',array());
        $ui_definition = $this->ui_data_controls_definition($ui_definition, 'sp_variations_gallery_images_container',array());
