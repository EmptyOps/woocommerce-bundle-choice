		...
		if ( ! empty( $data['woo_dropdown_attribute_html_data']['options'] ) ) {
			if ( $data['woo_dropdown_attribute_html_data']['product'] && taxonomy_exists( $data['variable_item_data']['attribute'] ) ) {
				...
				foreach ( $data['variable_item_data']['terms'] as $term ) {
					...
					if ( in_array( $term->slug, $data['woo_dropdown_attribute_html_data']['options'], true ) ) {
						...
						$data['variable_item_data']['options_loop_is_selected'][$term->slug]['is_selected']    = ( sanitize_title( $data['woo_dropdown_attribute_html_data']['args']['selected'] ) == $term->slug );
						$data['variable_item_data']['options_loop_selected_class'][$term->slug]['selected_class'] = $data['variable_item_data']['options_loop_is_selected'][$term->slug]['is_selected'] ? 'selected' : '';
						$data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip']        = '';



						$data['variable_item_data']['options_loop_selected_class'][$term->slug]['selected_class'] = ( sanitize_title( $data['woo_dropdown_attribute_html_data']['args'][ 'selected' ] ) == $term->slug ) ? 'selected' : '';



						--------- a etlu wvs_default_variable_item alg che
							if ( $data['variable_item_data']['is_archive'] && ! $data['variable_item_data']['show_archive_tooltip'] ) {
								$data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip'] = false;
							}
						--------
						$data['variable_item_data']['options_loop_tooltip_html_attr'][$term->slug]['tooltip_html_attr']       = ! empty( $data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip'] ) ? sprintf( ' data-wvstooltip="%s"', esc_attr( $data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip'] ) ) : '';
						$data['variable_item_data']['options_loop_screen_reader_html_attr'][$term->slug]['screen_reader_html_attr'] = $data['variable_item_data']['options_loop_is_selected'][$term->slug]['is_selected'] ? ' aria-checked="true"' : ' aria-checked="false"';

						if ( wp_is_mobile() ) {
							$data['variable_item_data']['options_loop_tooltip_html_attr'][$term->slug]['tooltip_html_attr'] .= ! empty( $data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip'] ) ? ' tabindex="2"' : '';
						}

						--------- a etlu wvs_default_variable_item alg che
							$data['variable_item_data']['options_loop_type'][$term->slug]['type'] = isset( $data['variable_item_data']['assigned'][ $term->slug ] ) ? $data['variable_item_data']['assigned'][ $term->slug ]['type'] : $data['woo_dropdown_attribute_html_data']['type'];

							if ( ! isset( $data['variable_item_data']['assigned'][ $term->slug ] ) || empty( $data['variable_item_data']['assigned'][ $term->slug ]['image_id'] ) ) {
								$data['variable_item_data']['options_loop_type'][$term->slug]['type'] = 'button';
							}
						-------
						...
						$data .= sprintf( '<li %1$s class="variable-item %2$s-variable-item %2$s-variable-item-%3$s %4$s" title="%5$s" data-title="%5$s" data-value="%3$s" role="radio" tabindex="0"><div class="variable-item-contents">', $data['variable_item_data']['options_loop_screen_reader_html_attr'][$term->slug]['screen_reader_html_attr'] . $data['variable_item_data']['options_loop_tooltip_html_attr'][$term->slug]['tooltip_html_attr'], esc_attr( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ), esc_attr( $term->slug ), esc_attr( $data['variable_item_data']['options_loop_selected_class'][$term->slug]['selected_class'] ), $data['variable_item_data']['options_loop_option'][$term->slug] );

						switch ( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ):
							case 'color':

								$data['variable_item_data']['options_loop_color'][$term->slug]['color'] = sanitize_hex_color( wvs_get_product_attribute_color( $term ) );
								$data  .= sprintf( '<span class="variable-item-span variable-item-span-%s" style="background-color:%s;"></span>', esc_attr( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ), esc_attr( $color ) );
							...
							case 'image':
								--------- a etlu wvs_default_variable_item alg che
									$data['variable_item_data']['options_loop_attachment_id'][$term->slug]['attachment_id'] = $data['variable_item_data']['assigned'][ $term->slug ]['image_id'];
									$data['variable_item_data']['options_loop_image_size'][$term->slug]['image_size']    = sanitize_text_field( woo_variation_swatches()->get_option( 'attribute_image_size' ) );
								-------
								$data['variable_item_data']['options_loop_attachment_id'][$term->slug]['attachment_id'] = apply_filters( 'wvs_product_global_attribute_image_id', absint( wvs_get_product_attribute_image( $term ) ), $term, $data['woo_dropdown_attribute_html_data']['args'] );
								$data['variable_item_data']['options_loop_image_size'][$term->slug]['image_size']    = woo_variation_swatches()->get_option( 'attribute_image_size' );
							...
							case 'button':
								$data .= sprintf( '<span class="variable-item-span variable-item-span-%s">%s</span>', esc_attr( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ), $data['variable_item_data']['options_loop_option'][$term->slug] );
								break;

							case 'radio':
								$data['variable_item_data']['options_loop_id'][$term->slug]['id']    = uniqid( $term->slug );
			...
			--------- a etlu wvs_default_variable_item alg che
					...
					foreach ( $data['woo_dropdown_attribute_html_data']['options'] as $option ) {
						...
						$data['variable_item_data']['options_loop_is_selected'][$term->slug]['is_selected'] = ( sanitize_title( $data['variable_item_data']['options_loop_option'][$term->slug] ) == sanitize_title( $data['woo_dropdown_attribute_html_data']['args']['selected'] ) );

						$data['variable_item_data']['options_loop_selected_class'][$term->slug]['selected_class'] = $data['variable_item_data']['options_loop_is_selected'][$term->slug]['is_selected'] ? 'selected' : '';
						$data['variable_item_data']['options_loop_tooltip'][$term->slug]['tooltip']        = trim( apply_filters( 'wvs_variable_item_tooltip', $data['variable_item_data']['options_loop_option'][$term->slug], $data['woo_dropdown_attribute_html_data']['options'], $data['woo_dropdown_attribute_html_data']['args'] ) );
						...
						$data['variable_item_data']['options_loop_type'][$term->slug]['type'] = isset( $data['variable_item_data']['assigned'][ $data['variable_item_data']['options_loop_option'][$term->slug] ] ) ? $data['variable_item_data']['assigned'][ $data['variable_item_data']['options_loop_option'][$term->slug] ]['type'] : $data['variable_item_data']['options_loop_type'][$term->slug]['type'];
						...
						$data .= sprintf( '<li %1$s class="variable-item %2$s-variable-item %2$s-variable-item-%3$s %4$s" title="%5$s" data-title="%5$s"  data-value="%3$s" role="radio" tabindex="0"><div class="variable-item-contents">', $screen_reader_html_attr . $tooltip_html_attr, esc_attr( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ), esc_attr( $data['variable_item_data']['options_loop_option'][$term->slug] ), esc_attr( $data['variable_item_data']['options_loop_selected_class'][$term->slug]['selected_class'] ), esc_html( $data['variable_item_data']['options_loop_option'][$term->slug] ) );

						switch ( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ):

							case 'image':
								$data['variable_item_data']['options_loop_attachment_id'][$term->slug]['attachment_id'] = $data['variable_item_data']['assigned'][ $data['variable_item_data']['options_loop_option'][$term->slug] ]['image_id'];
								$data['variable_item_data']['options_loop_image_size'][$term->slug]['image_size']    = sanitize_text_field( woo_variation_swatches()->get_option( 'attribute_image_size' ) );
								$data['variable_item_data']['options_loop_image'][$term->slug]['image']         = wp_get_attachment_image_src( $data['variable_item_data']['options_loop_attachment_id'][$term->slug]['attachment_id'], apply_filters( 'wvs_product_attribute_image_size', $data['variable_item_data']['options_loop_image_size'][$term->slug]['image_size'], $data['variable_item_data']['attribute'], $data['woo_dropdown_attribute_html_data']['product'] ) );
							...
							case 'button':
								$data .= sprintf( '<span class="variable-item-span variable-item-span-%s">%s</span>', esc_attr( $data['variable_item_data']['options_loop_type'][$term->slug]['type'] ), esc_html( $option ) );
								break;
