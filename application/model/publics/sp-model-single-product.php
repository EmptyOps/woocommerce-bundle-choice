		...
		if (false) {
			add_action('wp_footer',function(){
				...
				ob_start();
					...
					?>
					    <style type="text/css">
					        .ui.mini.images .variable-item.image{width:auto}.image-variable-item{border:none!important;border-bottom:2px solid transparent!important}
					        body .image-variable-item.selected,.image-variable-item:hover{                      
					            box-shadow: none !important;                    
					            border-bottom: 2px <?php _e($border_hover_color) ?> solid !important;
					        }
					...
					?>
					    <script>
					        jQuery(document).ready(function($){
					            ...
					            $(".variable-item").on("click",(function(){var e=$("#"+$(this).data("id"));e.val($(this).data("value")),$(this).parent().find(".selected").removeClass("selected"),$(this).addClass("selected"),jQuery(".variations_form").trigger("check_variations"),$(e).trigger("change")})),jQuery(".variations_form").on("click",".reset_variations",(function(){jQuery(".variable-items-wrapper .selected").removeClass("selected"),jQuery(".variable-items-wrapper .dropdown").dropdown("restore defaults")}));
