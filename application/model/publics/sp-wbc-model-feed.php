...
use eo\wbc\system\core\publics\SP_WBC_Feed;

class SP_WBC_Model_Feed extends SP_WBC_Feed {
	...
	public function render_gallery_images() {
		...
		add_filter( 'woocommerce_post_class', function( $classes, $product ) {
			...
			$classes[] = sprintf( 'wbc-sp-variations-gallery_images-woopost-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
		...
		add_filter( 'body_class',  function($classes){
			...
			$classes[] = sprintf( 'wbc-sp-variations-gallery_images-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
		...
		add_filter( 'post_class',  function($classes){
			...
			$classes[] = sprintf( 'wbc-sp-variations-gallery_images-post-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
	...
	public function render_variations_swatches() {
		...
		add_action('wp_footer',function(){
			...
			$asset_params['toggle_text'] = wbc()->options->get_option('tiny_features','tiny_features_option_ui_toggle_text',__('CUSTOMIZE THIS PRODUCT', 'woo-bundle-choice'));
		...
		add_filter( 'woocommerce_post_class', function( $classes, $product ) {
			...
			$classes[] = sprintf( 'wbc-sp-variations-swatches-woopost-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
		...
		add_filter( 'body_class',  function($classes){
			...
			$classes[] = sprintf( 'wbc-sp-variations-swatches-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
		...
		add_filter( 'post_class',  function($classes){
			...
			$classes[] = sprintf( 'wbc-sp-variations-swatches-post-theme-%s', wbc()->common->sp_wbc_current_theme_key() );
	...
	public function load_asset(){
			...
			// wbc_pr("SP_WBC_Model_Feed load_asset");

		add_action( 'wp_footer'/*'wp_enqueue_scripts'*/ ,function(){
			// wbc_pr("SP_WBC_Model_Feed load_asset wp_footer");
	...
	public function render_gallery_images_template_callback($args = array()){
		...
		// $data = \eo\wbc\model\publics\SP_WBC_Model_Feed::instance()->get_data('gallery_images');
		...
		// 	wbc_pr("wbc SP_WBC_Model_Feed render_gallery_images_template_callback");
		// 	wbc_pr($data);
		// }
