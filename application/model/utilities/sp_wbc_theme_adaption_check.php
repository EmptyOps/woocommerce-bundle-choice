...
wbc()->load->model('publics/sp_wbc_base_model_publics');

use eo\wbc\model\publics\SP_WBC_Base_Model_Publics;

class SP_WBC_Theme_Adaption_Check extends SP_WBC_Base_Model_Publics {
	...
	public static function sp_wbc_current_theme_key() {
	...
	public function check($config){
		...
		$curr_theme_key = self::sp_wbc_current_theme_key();
