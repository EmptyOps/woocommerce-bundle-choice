...
class SP_WBC_Price_Control_Save_Update_Prices {
	...
	public static function price_markup_def_apply_rules($prices_data, $args = array()) {
		...
		if( wbc()->sanitize->get('is_test') == 1 ) {
			...
			wbc_pr("SP_WBC_Price_Control_Save_Update_Prices price_markup_def_apply_rules 1");
			wbc_pr($prices_data);
		}
	...
	public static function apply_rule( $rule, $price, $is_sales_price ) {
		...
		// 	wbc_pr("SP_WBC_Price_Control_Save_Update_Prices apply_rule 1");
		// 	wbc_pr($rule);
		// 	wbc_pr($price);
		// }
