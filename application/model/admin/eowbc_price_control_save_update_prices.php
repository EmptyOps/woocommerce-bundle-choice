...
class Eowbc_Price_Control_Save_Update_Prices {
	...
	public static function api_price_markup($price) {
		return $price;
		// ACTIVE_TODO/NOTE: Below section is a patch fix pulled from dev branch into QCed branch on 08-08-2023. and in dev branch it might be applied during the end of 2021 or in beginning quarter of the 2022. we have kept it commented for now but in future during upgrades or bug fixing if we find it useful then we may like to take note of the flows related to ratio price or make use of some this code. but we may need to look at the related changes in admin interface means if the ratio field is added and any other related changes and so on to better understand if this section have anything to make use of.  
