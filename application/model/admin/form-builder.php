...
class Form_Builder implements Builder {
	...
	private function dynamic_add_support_plus_button(string $field_id, $sub_elements, &$container_html, $das_fields_details_for_export) {
		...
		$button = array(
				...
				'attr'=>array('href="javascript:void(0);"', "onclick='window.document.splugins.common.admin.form_builder.api.das_add( \"".esc_attr($field_id)."\", \"".esc_attr($plus_button_id)."\", \"wp\" ); return false;'", 'data-das_fields=\''.wp_json_encode($das_fields_details_for_export).'\'')
