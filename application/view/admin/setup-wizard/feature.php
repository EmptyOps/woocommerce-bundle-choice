...
?>
			...
			<div class="ui form segment">
			  	<div class="grouped fields">
			    	...
			    	<label class="ui large text"><?php esc_html_e('Choose features', 'woo-bundle-choice'); ?> <span class="ui medium grey text"><?php echo esc_html(eowbc_lang("(You can later change these options from Settings page)")); ?></span></label>
		    		...
		    		?>
						<div class=" field">
						    <div class="ui toggle checkbox">
						      	<input type="checkbox" tabindex="0" class="hidden" name="api_integrations" value="1" <?php echo array_key_exists('api_integrations', esc_attr($feature_option)) ? 'checked="checked"' : ''; ?>>
