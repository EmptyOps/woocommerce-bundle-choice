			...
			<div class="ui form segment">
			  	<div class="grouped fields">
			    	...
			    	<?php if(wbc()->sanitize->get('eo_wbc_inventory_type') == 'jewelry'): ?>	
		      		<div class="field">
					    <div class="ui toggle checkbox">
					      	<input type="checkbox" tabindex="0" class="hidden" name="ring_builder" id="ring_builder" value="1" <?php echo array_key_exists('ring_builder', esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
					...
					<?php if(wbc()->sanitize->get('eo_wbc_inventory_type') == 'clothing'): ?>	
		      		<div class=" field">
					    <div class="ui toggle checkbox">
					      	<input type="checkbox" tabindex="0" class="hidden" name="pair_maker" value="1" <?php echo array_key_exists('pair_maker', esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
		    		...
		    		?>
			      		<div class=" field">
						    <div class="ui toggle checkbox">
						      	<input type="checkbox" tabindex="0" class="hidden" name="rapnet_api" value="1" <?php echo array_key_exists('rapnet_api',esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
						...
						<div class=" field">
						    <div class="ui toggle checkbox">
						      	<input type="checkbox" tabindex="0" class="hidden" name="glowstar_api" value="1" <?php echo array_key_exists('glowstar_api', esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
					...
					<div class=" field">
					    <div class="ui toggle checkbox">
					      	<input type="checkbox" tabindex="0" class="hidden" name="guidance_tool" value="1" <?php echo array_key_exists('guidance_tool', esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
		    		...
		    		?>
						<div class=" field">
						    <div class="ui toggle checkbox">
						      	<input type="checkbox" tabindex="0" class="hidden" name="api_integrations" value="1" <?php echo array_key_exists('api_integrations', esc_attr($feature_option)/*$feature_option*/)?'checked="checked"':''; ?>>
	 					...
	 					<div class="grouped fields">
							<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="filters_shortcode" id="filters_shortcode" <?php echo array_key_exists('filters_shortcode', esc_attr($bonus_features)/*$bonus_features*/)?'checked="checked"':''; ?> value="filters_shortcode">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="filters_shop_cat" id="filters_shop_cat" <?php echo array_key_exists('filters_shop_cat', esc_attr($bonus_features)/*$bonus_features*/)?'checked="checked"':''; ?> value="filters_shop_cat">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="opts_uis_item_page" id="opts_uis_item_page" <?php echo array_key_exists('opts_uis_item_page', esc_attr($bonus_features)/*$bonus_features*/)?'checked="checked"':''; ?> value="opts_uis_item_page">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="spec_view_item_page" id="spec_view_item_page" <?php echo array_key_exists('spec_view_item_page', esc_attr($bonus_features)/*$bonus_features*/)?'checked="checked"':''; ?> value="spec_view_item_page">
				    		...
				    		<div class="field">
			    				<div class="ui toggle checkbox fluid">
			        				<input type="checkbox" name="price_control" id="price_control" <?php echo array_key_exists('price_control', esc_attr($bonus_features)/*$bonus_features*/)?'checked="checked"':''; ?> value="price_control">
