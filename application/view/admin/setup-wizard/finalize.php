			...
			<div class="ui form segment">			  	
				...
				<div class="segment">
					<div class="ui list">
						...
						<div class="item">
							<i class="<?php (in_array($feature,$available_sample)?esc_attr('check green'):esc_attr('exclamation')) ?> icon"></i>	
				...
				<div class="ui form">
					<div class="inline fields">
						...
						<div class="field">
						    <div class="ui inverted green button <?php echo empty(array_intersect(array_keys($features), $available_sample)) ? esc_attr('disabled') : ''; ?>" id="create_product" data-link="<?php echo esc_url(admin_url("admin.php?setup_wizard_run=1&page=eowbc&eo_wbc_view_auto_jewel=1&f=" . implode(',', $features))); ?>">Add sample and Finish</div>	
						</div>
						<div class="field">
