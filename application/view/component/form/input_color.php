...
if(!empty($id) /*and !empty($label)*/){
	...
	<div class="<?php echo !empty($size_class)?$size_class:''; ?> field">
		...
		?>	
		<input type="color" <?php echo !empty($attr)?$attr:''; ?> id="<?php echo $id; ?>" name="<?php echo $id; ?>" class="<?php echo !empty($class)?$class:''; ?>" placeholder="<?php echo !empty($placeholder)?$placeholder:''; ?>">	
		<?php
