...
if(!empty($attr) and is_string($attr) and strpos($attr,'href')!==false and !empty($id)) {
	?>
	<a <?php echo !empty($attr) ? $attr : ''; ?> id="<?php echo esc_attr($id); ?>" name="<?php echo esc_attr($id); ?>" class="ui <?php echo !empty($class) ? esc_attr($class) : ''; ?>"><?php echo !empty($label) ? esc_html($label) : ''; ?></a>
	...
	<div class="<?php echo !empty($size_class) ? esc_attr($size_class) : ''; ?> field">
		...
		?>	
		<input type="text" <?php echo !empty($attr) ? $attr : ''; ?> id="<?php echo esc_attr($id); ?>" name="<?php echo esc_attr($id); ?>" class="ui input <?php echo !empty($class) ? esc_attr($class) : ''; ?>" placeholder="<?php echo !empty($placeholder) ? esc_attr($placeholder) : ''; ?>" value="<?php echo isset($value) ? esc_attr($value) : ''; ?>">	
		<?php
