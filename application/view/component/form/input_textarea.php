...
if(!empty($id) /*and !empty($label)*/){
	...
	<div class="<?php echo !empty($size_class)?$size_class:''; ?> field">
		...
		?>		
		<textarea spellcheck="false"  id="<?php echo $id; ?>" name="<?php echo $id; ?>" class="ui input <?php echo !empty($class)?$class:''; ?>" placeholder="<?php echo $placeholder; ?>" ><?php echo isset($value)?$value:''; ?></textarea>		
		<?php
