...
?>
	<div class="<?php echo $width_class; ?>">
		<p>
			...
			<?php if($reset): ?>
			&nbsp; <span class="ui grey text" style="cursor: pointer;" onclick="reset_slider(event,'<?php echo $filter['slug'] ?>','<?php echo $filter['min_value']['name']; ?>','<?php echo $filter['max_value']['name']; ?>')">&nbsp;<u><?php echo eowbc_lang('reset'); ?></u></span>
			<?php endif; ?>
		</p>
