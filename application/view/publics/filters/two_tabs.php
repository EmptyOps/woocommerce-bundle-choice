...
if( true or in_array( wbc()->common->get_category('category',null,array(wbc()->options->get_option('configuration','first_slug'),wbc()->options->get_option('configuration','second_slug')),true), /*array($first_tab_category,$second_tab_category)*/$category_array ) ){  ?>
    <div class="ui top attached tabular menu filter_setting_advance_two_tabs" style="margin-top: 3em;">
        ...
        ?>
            <script type="text/javascript">
                    jQuery(document).ready((function(e){window.document.splugins.events.api.subscribeObserver("filter_sets","wbc","filter_set_click_before_loop",(function(e,i,n){n(i)}))}));
            </script>
        ...
        ?>
            <style>
            .tax-product_cat .eo-wbc-container.filters .ui.menu{-ms-flex-wrap:wrap;flex-wrap:wrap;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.tax-product_cat .eo-wbc-container.filters .ui.menu a.item.center{margin-left:0!important}
            </style>
