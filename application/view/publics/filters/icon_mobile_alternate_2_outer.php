...
<div class="ui form" style="padding-left: 1em;" data-tab-group="<?php _e($tab_set); ?>">
	<p style="display:inline-flex;vertical-align: middle;<?php _e(!empty($help)?'min-width: 16vw;':'');?>"class="ui three wide field num_slider">
	...
	<div style="display: inline-flex;" class="field twelve ui wide">
		<div class="ui tiny images scrollable_image_filters" style="text-align: center;overflow: auto;
  white-space: nowrap;" data-reset="reset_icon(new Event('click'),'<?php echo $term->slug; ?>')" data-filter-slug="<?php echo $term->slug; ?>">
		<?php foreach ($list as $filter_icon): ?>
			<div title="<?php $filter_icon["name"]; ?>"
				class="eo_wbc_filter_icon <?php echo ($non_edit and (empty(wbc()->sanitize->get('FIRST')) XOR empty(wbc()->sanitize->get('SECOND'))))?'none_editable':''; ?> 
				...
				data-filter="<?php echo $term->slug; ?>" style="border-bottom: 2px solid transparent;display: inline-block !important; "
