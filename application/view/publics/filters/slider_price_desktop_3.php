...
<div class="spui-semantic-slider-column <?php echo esc_attr($width_class); ?>">
	...
	<?php endif; ?>	
	data-min="<?php echo esc_attr($min); ?>" data-max="<?php echo esc_attr($max); ?>" data-slug="price" data-sep="<?php echo esc_attr($seprator); ?>" data-reset="reset_price(new Event('click'),'<?php echo esc_attr($min); ?>','<?php echo esc_attr($max); ?>')" data-prefix="<?php echo esc_attr($prefix); ?>" data-postfix="<?php echo esc_attr($postfix); ?>"></div>
</div>
