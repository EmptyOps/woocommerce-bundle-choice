	...
	<div style="display: inline-block;" class="field twelve ui wide">
		...
		<div class="ui tiny form" style="padding:0px 6%;">
		  <div class="three fields">
		    <div class="field">	      
		      <input style="font-size: 13px; height: 24px; width: 6em; -webkit-appearance: none;" value="<?php echo esc_attr($prefix.$min.$postfix)/*$prefix.$min.$postfix*/; ?>" type="text" class="text_slider_price aligned left" name="text_min_price" data-sep="<?php _e($seprator); ?>">
		    </div>
		    <div class="field"></div>
		    <div class="field">	      
		      <input style="font-size: 13px; height: 24px;" value="<?php echo esc_attr($prefix.$max.$postfix)/*$prefix.$max.$postfix*/;; ?>" type="text" class="text_slider_price aligned right" name="text_max_price" data-sep="<?php _e($seprator); ?>">
		    </div>
		  </div>	  
		</div>				
	</div>
