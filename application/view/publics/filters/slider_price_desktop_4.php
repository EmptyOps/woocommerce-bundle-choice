	...
	<div style="display: inline-block;" class="field twelve ui wide">
		...
		<div class="ui range slider text_slider" id="text_slider_price" data-min="<?php echo $min; ?>" data-max="<?php echo $max; ?>" data-slug="price" style="padding-bottom: 0px !important" data-reset="reset_price(new Event('click'),'<?php echo $min; ?>','<?php echo $max; ?>')"></div><div class="ui tiny form" style="padding:0px 6%;">
		  <div class="three fields">
		    ...
		    <div class="field"></div>
		    <div class="field">	      
		      <input style="font-size: 13px; height: 24px; width: 6em; -webkit-appearance: none;position: absolute;right: 6%;" value="<?php echo $max; ?>" type="text" class="text_slider_price aligned right" name="text_max_price" data-sep="<?php _e(wbc()->options->get_option('filters_filter_setting','filter_setting_numeric_slider_seperator','.')); ?>">
		    </div>
		  </div>	  
		</div>				
	</div>
