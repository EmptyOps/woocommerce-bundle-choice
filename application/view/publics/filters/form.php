...
?>	
	...
	?>
	    <script type="text/javascript">     
	        ...
	        jQuery(document).ready((function(n){window.document.splugins=window.document.splugins||{},window.document.splugins.ui=window.document.splugins.ui||{},window.document.splugins.ui.slider=window.document.splugins.ui.slider||jQuery.fn.slider;var i=jQuery(".eo-wbc-container.filters .ui.segment:not(.secondary)"),e=(jQuery(i).find(".computer.tablet.only"),jQuery(i).find(".mobile.only"),".eo-wbc-container.filters .ui.segment.secondary"),r=jQuery(e).find(".computer.tablet.only"),o=jQuery(e).find(".mobile.only");"function"==typeof jQuery.fn.accordion&&jQuery(".ui.accordion").accordion(),"none"!=jQuery(r).css("display")?jQuery("#advance_filter").on("click",(function(){jQuery("#advance_filter").find(".ui.icon").toggleClass("up down"),jQuery(e+":eq(0)").transition("slide down")})).trigger("click"):"none"!=jQuery(o).css("display")&&jQuery("#advance_filter").on("click",(function(){jQuery(this).find(".ui.icon").toggleClass("up down"),jQuery(e).transition("fly right")})).trigger("click"),"none"!=jQuery("#primary_filter").parent().parent().css("display")&&jQuery("#primary_filter").click((function(n){n.preventDefault(),n.stopPropagation(),jQuery("#primary_filter").find(".ui.icon").toggleClass("down up"),jQuery(".eo-wbc-container.filters,#advance_filter").transition("fade")})).trigger("click")}));
	    </script>
