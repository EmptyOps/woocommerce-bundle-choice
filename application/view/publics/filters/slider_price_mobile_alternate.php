...
?>			
<div class="ui four wide column toggle_sticky_mob_filter" style="<?php echo esc_attr($advance?'display: none;':'')/*$advance?'display: none;':''*/ ?>" data-target="#sticky_mob_filter_price">
	<div class="title"><div class="ui segment"> <?php spext_lang("Price", 'woo-bundle-choice') ?></div></div>
</div>
<div class="bottom_filter_segment hidden ui segment" id="sticky_mob_filter_price">
	<div class="ui equal width grid">
		...
		<div class="column"></div>
		<div class="column" style="text-align: right;" onclick="reset_price(event,'<?php echo esc_attr($min)/*$min*/; ?>','<?php echo esc_attr($max)/*$max*/; ?>')">
			<i class="ui icon redo" style="cursor: pointer;"></i>&nbsp;Reset
		</div>
	</div>					
	<br/>
	<div class="ui title">
		<strong><?php spext_lang("Price", 'woo-bundle-choice') ?></strong><?php if(!empty($help)): ?>&nbsp;<i class="question circle outline icon" data-help="<?php echo esc_attr($help)/* $help*/; ?>"></i><?php endif; ?>
	</div><br/>
	<div class="content">	
