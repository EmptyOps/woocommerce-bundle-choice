...
<div class="content">	
	<div class="ui tiny images" style="text-align: center;" data-reset="reset_icon(new Event('click'),'<?php echo esc_attr($term->slug); ?>')" data-filter-slug="<?php echo esc_attr($term->slug); ?>">
		<?php foreach ($list as $filter_icon): ?>
			<div title="<?php esc_attr($filter_icon["name"]); ?>"
				...
				data-filter="<?php echo esc_attr($term->slug); ?>" style="border-bottom: 2px solid transparent;"
