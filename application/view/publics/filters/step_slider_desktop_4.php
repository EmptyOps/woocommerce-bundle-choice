...
<div class="<?php echo esc_attr($width_class); ?>" data-tab-group="<?php echo esc_attr($tab_set); ?>">
	<div style="display: inline-block;" class="ui three wide field text_slider">
		...
		<?php endif; ?>
		<?php if($reset): ?>
		&nbsp; <span class="ui grey text" style="cursor: pointer;" onclick="reset_slider(event,'<?php echo esc_attr($filter['slug']); ?>',0,<?php echo ecs_attr(count(array_filter($items_slug))); ?>)">&nbsp;<u><?php esc_html(sp_wbc_ext_lang("reset", 'woo-bundle-choice')) ?></u></span>
		<?php endif; ?>
	</div>
