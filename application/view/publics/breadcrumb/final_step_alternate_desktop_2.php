...
<div class="ui equal width middle aligned grid" style="width: 100%;padding-top: 0px;text-transform:none;font-family: 'ZapfHumanist601BT-Roman';">        
    ...
    <div class="ui column left aligned eowbc_breadcrumb_font"> <?php /*sp_wbc_ext_lang*/esc_html_e("3", 'woo-bundle-choice') ?> </div>
    <div class="ui column left aligned">
        <div class="title eowbc_breadcrumb_font"> <?php esc_html(sp_wbc_ext_lang("Complete", 'woo-bundle-choice')); ?> <?php echo esc_html($preview_name); ?></div>
    </div>
