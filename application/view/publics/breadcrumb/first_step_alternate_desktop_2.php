        ...
        <div class="ui column left aligned eowbc_breadcrumb_font">
            ...
            <?php } else { ?>
                ...
                <div class="ui small hover green text eowbc_breadcrumb_font">                
                    <u><a href="<?php echo /*!empty(wbc()->sanitize->get('FIRST')) ? eo\wbc\model\publics\component\EOWBC_Breadcrumb::eo_wbc_breadcrumb_view_url(wbc()->sanitize->get('FIRST'),$order):'#'*/!empty(wbc()->sanitize->get('FIRST')) ? wbc()->common->beautify_url_data(eo\wbc\model\publics\component\EOWBC_Breadcrumb::eo_wbc_breadcrumb_view_url(wbc()->sanitize->get('FIRST'),$order)):'#'; ?>">View</a></u>&nbsp;|&nbsp;<u><a href="<?php echo /*!empty(wbc()->sanitize->get('FIRST'))?eo\wbc\model\publics\component\EOWBC_Breadcrumb::eo_wbc_breadcrumb_change_url($order,wbc()->sanitize->get('FIRST')):'#'*/!empty(wbc()->sanitize->get('FIRST')) ? wbc()->common->beautify_url_data(eo\wbc\model\publics\component\EOWBC_Breadcrumb::eo_wbc_breadcrumb_change_url($order,wbc()->sanitize->get('FIRST'))):'#'; ?>"><?php _e(wbc()->options->get_option('appearance_breadcrumb','appearance_breadcrumb_change_action_text','Change',true,true)); ?></a></u>
                </div>    
