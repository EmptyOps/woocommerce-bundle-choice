...
?>
<div class="<?php echo esc_attr(($step == $order) ? 'active ' : (($step > $order) ? 'completed ' : (!empty(\eo\wbc\model\publics\component\SP_WBC_Breadcrumb::$clickable_breadcrumb) ? '' : 'disabled'))); ?> step">
