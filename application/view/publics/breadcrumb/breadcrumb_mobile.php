...
<div class="ui container unstackable steps" style="direction: ltr;width: 100% !important; min-width: unset; max-width: unset; margin: auto; margin-bottom: 1em;">
    ...
    <div 
        ...
        class="<?php echo esc_attr((($step==3)?'active ':(($step>3)?'completed ':(!empty(\eo\wbc\model\publics\component\EOWBC_Breadcrumb::$clickable_breadcrumb)?'':'disabled'))))/*(($step==3)?'active ':(($step>3)?'completed ':(!empty(\eo\wbc\model\publics\component\EOWBC_Breadcrumb::$clickable_breadcrumb)?'':'disabled')))*/; ?> step">
        <div class="content"><?php echo esc_html($breadcrumb_ui::$preview_name)/*$breadcrumb_ui::$preview_name*//*get_option('eo_wbc_collection_title','Preview')*/; ?></div>
    </div>
</div>
<script>
