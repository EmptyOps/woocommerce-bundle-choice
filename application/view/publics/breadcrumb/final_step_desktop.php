...
<div class="ui equal width grid" style="width: 100%;margin-top: -2em !important;">
    ...
    <div class="column" <?php echo empty(wp_get_attachment_url(wbc()->options->get_option('configuration','preview_icon')/*get_option('eo_wbc_collection_icon')*/))?'style="visibility: hidden;"':""; ?>><img src="<?php echo $preview_icon/*get_option('eo_wbc_collection_icon')*/; ?>" style="margin: auto auto;<?php echo empty($preview_icon)?'visibility: hidden;':''; ?>"/></div>                            
</div>                        