...
// 	$custom_css = ".eo-wbc-container.container{
...
// 	    " . (
// 	        $breadcrumb_backcolor_inactive ?
// 	        ".eo-wbc-container>.ui.steps .step:not(.active), .eo-wbc-container>.ui.steps .step:not(.active):after {
// 	            background: $breadcrumb_backcolor_inactive;
// 	        }" : ''
// 	    ) . (
// 	        $fg_color ?
// 	        ".eo-wbc-container>.ui.steps .step.active, .eo-wbc-container>.ui.steps .step.active:after {
// 	            background: $fg_color;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->session->get('EO_WBC_FG_COLOR')) ?
// 	        " .eo-wbc-container>.ui.steps .step.active .title, .eo-wbc-container>.ui.steps .step.active a {
// 	            color: " . wbc()->session->get('EO_WBC_FG_COLOR', '#fff') . ";
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_num_icon_backcolor_inactive', '#ffffff')) ?
// 	        " .eo-wbc-container .step:not(.active) .column:first-of-type {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_num_icon_backcolor_inactive', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_num_icon_backcolor_active', '#ffffff')) ?
// 	        " .eo-wbc-container .step.active .column:first-of-type {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_num_icon_backcolor_active', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_actions_backcolor_inactive', '#ffffff')) ?
// 	        " .eo-wbc-container .step:not(.active) a {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_actions_backcolor_inactive', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_actions_backcolor_active', '#ffffff')) ?
// 	        " .eo-wbc-container .step.active a {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_actions_backcolor_active', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_title_backcolor_inactive', '#ffffff')) ?
// 	        " .eo-wbc-container .step:not(.active) .title {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_title_backcolor_inactive', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) . (
// 	        !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_title_backcolor_active', '#ffffff')) ?
// 	        " .eo-wbc-container .step.active .title {
// 	            color: " . wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_title_backcolor_active', '#ffffff') . " !important;
// 	        }" : ''
// 	    ) .  (
// 		    !empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_step_size')) ?
// 		    ".eo-wbc-container.container:not(.filters) .ui.steps .step .column:first-of-type { font-size: $breadcrumb_step_size !important; }" : ''
// 		) . (
// 		    !empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_header_size')) ?
// 		    ".eo-wbc-container.container:not(.filters) .ui.steps .step .column:nth-child(2) { font-size: $breadcrumb_header_size !important; }" : ''
// 		) . (
// 		    !empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_icon_size')) ?
// 		    ".eo-wbc-container.container:not(.filters) .ui.steps .step img { width: $breadcrumb_icon_size !important; }" : ''
// 		) . (
// 		    !empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_wrap_mobile')) ?
// 		    ".ui.container.unstackable.steps .step { max-width: 33.33%; margin: auto !important; margin: 0px !important; }" : ''
// 		) . (
// 		    !empty(wbc()->options->get_option('appearance_breadcrumb', 'breadcrumb_radius', '2')) ?
// 		    ".eo-wbc-container>.ui.steps { border-radius: $breadcrumb_radius; overflow: hidden; } .eo-wbc-container>.ui.steps .step { border-radius: 0px !important; }" : ''
// 		) . (
// 		    /*!wp_is_mobile()*/ !wbc_is_mobile_by_page_sections('cat_shop_page', true) ?
// 		    ".eo-wbc-container>.ui.steps .step { margin-bottom: 0px !important; } .eo-wbc-container>.ui.steps div { cursor: pointer !important; } .ui.steps .step .column { z-index: 7; width: max-content !important; padding-left: 0em !important; } .ui.steps .step .column:first-child { " . (wbc()->options->get_option('configuration', 'config_alternate_breadcrumb', 'default') == 'template_1' ? "" : "font-size: 3.2em !important;") . " line-height: 0.8em; text-align: right; padding-right: 0.125rem !important; } .ui.steps .step { padding-right: 0px !important; padding-left: 3em !important; } .eo-wbc-container>.ui.steps .step:first-child { padding-left: 1em !important; } .eo-wbc-container>.eo-wbc-container>.ui.steps .step:last-child { padding-right: 0px !important; } .eo-wbc-container>.ui.steps .step .column:last-child { padding-right: 0px !important; text-align: center; } .eo-wbc-container>.ui.steps .step .column.product_image_section img { height: 4.5em !important; width: auto !important; margin-left: 45%; } .eo-wbc-container .ui.steps { text-transform: uppercase; } .eo-wbc-container.container .ui.steps { width: 100%; } .eo-wbc-container.container .ui.steps .step { padding-top: 1rem !important; padding-bottom: 2rem !important; " . (empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_hide_border')) ? '' : 'border: none !important;') . " } .eo-wbc-container.container .ui.steps { " . (empty(wbc()->options->get_option('appearance_breadcrumb', 'appearance_breadcrumb_hide_border')) ? '' : 'border: none !important;') . " } " . (wbc()->options->get_option('configuration', 'config_alternate_breadcrumb', 'default') == 'template_1' ? ".eo-wbc-container>.ui.steps .step .column:first-child { font-size: 3.2em !important; text-align: center; line-height: 1.8rem; } .eo-wbc-container>.ui.steps .step .column { padding: 0.5rem; }" : ".eo-wbc-container>.ui.steps .step:after { width: 3.3em; height: 3.3em; }") . " .eo-wbc-container>.ui.steps div { margin-top: 0px !important; } @media only screen and (max-width: 768px) { .eo-wbc-container>.ui.steps .step { padding-left: 1rem !important; } .eo-wbc-container>.ui.steps .step .column { padding-right: 0em !important; text-align: right; } .eo-wbc-container>.ui.steps .step:last-child { padding-right: 0.5em !important; } }" : ".ui.steps .step
// 		";
