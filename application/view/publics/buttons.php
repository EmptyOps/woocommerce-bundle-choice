...
$first_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link($first_slug);

$second_url = \eo\wbc\model\SP_WBC_Category_Attribute::instance()->get_category_link($second_slug);
...
if(!function_exists('sp_wbc_code')){
	function sp_wbc_code() //script to get color code from buttons
	{
...
//moved from the home class of older version 
if(!function_exists('sp_wbc_buttons_css')){
	function sp_wbc_buttons_css(){
...
<div id="wbc_" class="eo_wbc_container" <?php echo (isset($is_embed_using_js) && $is_embed_using_js) ? 'style="display: none !important;"' : '';?>>
	...
	<?php echo sp_wbc_buttons_css(); ?>
	<br/><br/>
	<?php echo sp_wbc_code(); ?>
</div>
<!-- Created with Wordpress plugin - BUNDLOICE (formerly Woo Choice Plugin) -->
