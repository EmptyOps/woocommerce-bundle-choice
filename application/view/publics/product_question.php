<div type="submit" name="eowbc-askq" id="eowbc-askq" value="<?php echo $product_id; ?>" class="ui inverted primary button" style="margin-left: 1em;"><?php echo eowbc_lang('Question?'); ?></div>


<div class="ui tiny modal" id="eowbc-askq-modal" data-modal-name="eowbc-askq-modal">  	
  	<div class="header"><?php echo eowbc_lang('ASK US ABOUT THIS DIAMOND'); ?></div>
  	<div class="content ui form">
    	<!-- <form class="ui form" name="api_new_form" id="eowbc_askq_form"> -->      
	      	<div class="field required">
	        	<label><?php echo eowbc_lang('YOUR FIRST NAME'); ?></label>                
	      	...
	      	<div class="field required">
	        	<label><?php echo eowbc_lang('YOUR LAST NAME'); ?></label>                
	        	<input type="text" name="eowbc_askq_lname" id="eowbc_askq_lname">        
	      	</div>
	      	<div class="field required">
	        	<label><?php echo eowbc_lang('YOUR EMAIL'); ?></label>        
	         	<input type="email" name="eowbc_askq_email" id="eowbc_askq_email">
	        </div>              
	      	<div class="field required">
	        	<label><?php echo eowbc_lang('YOUR PHONE NUMBER'); ?></label>        
		...
		$("#eowbc_askq_save").click(function(){
			...
			jQuery.ajax({
	            ...
	            success:function(result,status,xhr){
	               if(result){
	               		alert(eowbc_lang('Your query has been sent successfully, you will hear back soon.'));
	               }
	            },
