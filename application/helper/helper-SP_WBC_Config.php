	...
	public function explicit_class_loader_config( $singleton_functionUpper ) {
		...
		return array(
			'admin'=> array(
				...
				array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY').'application/system/core/publics/sp_wbc_base_model_publics.php' ), 
			...
			'frontend'=> array(
				...
				array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."/application/controllers/publics/variations/sp-gallery-zoom.php" ), 
		 		...
		 		array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."/application/model/admin/sp_wbc_model.php" ), 
				...
				array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."vendor/sphereplugins/selectron/vendor/autoload.php" ),
		 		...
		 		array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."/application/system/core/sp-wbc-ui-builder.php" ),
		 		array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."/application/system/core/sp-wbc-page-builder.php" ),

			), 
			'both'=> array(

				array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY').'application/system/core/publics/sp-wbc-query.php' ), 

		 		array( 'type'=>'file', 'path'=> constant('EOWBC_DIRECTORY')."/application/model/publics/component/sp_wbc_filter_widget.php" ), 
