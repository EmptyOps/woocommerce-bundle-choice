...
function sp_wbc_extension_from_path($filepath) {

	return wbc()->file->extension_from_path($filepath);
}


function sp_wbc_file_exists($filepath) {

	return wbc()->file->file_exists($filepath);

}

function sp_wbc_file_write( $filepath, $content )
{
...
function sp_wbc_file_read( $filepath )
{
...
function sp_wbc_file_lines( $filepath )
{
...
function sp_wbc_rename_file($source, $dest) {

	return wbc()->file->rename_file($source, $dest);

}

function sp_wbc_delete_file($filepath) {

	return wbc()->file->delete_file($filepath);

}

function sp_wbc_unlink($filepath) {

	return wbc()->file->unlink($filepath);

}

function sp_wbc_list_files( $in_dir, $filter_by=null ) {

	return wbc()->file->list_files($in_dir, $filter_by);

}

function sp_wbc_delete_files( $in_dir, $filter_by=null ) {
	
	return wbc()->file->delete_files($in_dir, $filter_by);

}

function sp_wbc_save_json($filepath, $data) {

	return wbc()->file->save_json($filepath, $data);

}

function sp_wbc_get_json($filepath) {
