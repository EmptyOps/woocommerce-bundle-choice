...
try {
    ...
    $res = array(
        "type" => "error",
        "msg"  => !empty($errorMessage) ? $errorMessage : "There is some error in this sample data PHP process for the feature 'Jeweley'."
    );
    ...
    $res = array(
        "type" => "error",
        "msg"  => $e->getMessage() ?: "There is some error in this sample data PHP process for the feature 'Jeweley'."
    );
