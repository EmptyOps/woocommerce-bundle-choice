            ...
            {               
                if($set["FIRST"]){          
                    wc()->cart->add_to_cart(
                        ...
                        ($set["FIRST"][2]=='0'?NULL:wbc()->wc->eo_wbc_get_product_variation_attributes($set["FIRST"][2],$set["FIRST"]['variation']))
                      );
                }
                ...
                if($set["SECOND"])
                {
                    wc()->cart->add_to_cart(
                        ...
                        ($set["SECOND"][2]=='0'?NULL:wbc()->wc->eo_wbc_get_product_variation_attributes($set["SECOND"][2],$set["SECOND"]['variation']))
                      );
                }
            }   
        }                
