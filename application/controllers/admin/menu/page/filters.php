		...
		public static function get_form_definition( $is_add_sample_values = false ) {
			...
			$form_definition = array(
				...
				's_fconfig'=>array(
					...
					'form'=>array( 
						's_fconfig_section'=>array('label'=>'Manage filters of '.(($inventory_type==='jewelry' and $is_ring_builder)?"Settings":"Second"),'type'=>'segment','desc'=>'Add/Edit the filters and set their orderings.'
						),
