					...
					array(
						...
						'config_navigation_conf'=>array(
								...
								'form'=>array(
									...
									'config_alternate_breadcrumb_mobile'=>array(
										'label'=>'Alternate Breadcrumb Widgets - Mobile',
										'type'=>'radio',
										'value'=>wbc()->options->get_option('configuration','config_alternate_breadcrumb_mobile','default'),
										'validate'=>array('required'=>''),
										'sanitize'=>'sanitize_text_field',
										'options'=>array('default'=>'Default','template_1'=>'Template 1'),
										'class'=>array(),				
										'size_class'=>array('required'),
										'visible_info'=>array( 'label'=>'( Switch to other look of breadcrumb on mobile. )',
											'type'=>'visible_info',
											'class'=>array('fluid', 'small'),
											'size_class'=>array('sixteen','wide'),
										),	
