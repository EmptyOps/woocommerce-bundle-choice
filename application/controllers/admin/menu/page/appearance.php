				...
				'preview_page'=>array(
					...
					'form'=>array(
						...
						'show_cards_view'=>array(
							...
							'is_id_as_name'=>true,
							'class'=>array(),
							'visible_info'=>array( 'label'=>'If enabled instead of the standard preview page the cards view will be disaplyed.',
								'type'=>'visible_info',
								'class'=>array('fluid', 'small'),
								'size_class'=>array('sixteen','wide'),
							),	
