			...
			$form_definition = array(
				...
				'global' => array(
					...
					'form' => array(
						...
						'theme_primary_color_shade' => array(
							'label' => 'Theme Primary Color Shade',
							'type' => 'color',
							'sanitize' => 'sanitize_hex_color',
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade', '#ffffff', true, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
						...
						'theme_secondary_color_shade' => array(
							'label' => 'Theme Secondary Color Shade',
							'type' => 'color',
							'sanitize' => 'sanitize_hex_color',
							'value' => wbc()->options->get_option('appearance_global', 'theme_secondary_color_shade', '#ffffff', true, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
