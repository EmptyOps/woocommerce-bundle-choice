		...
		public static function get_form_definition( $is_add_sample_values = false ) {
			...
			$form_definition = array(
				'wid_btns'=>array(
						...
						'label'=>eowbc_lang('Buttons Widget'),
						'form'=> array_merge( \eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection( "tagline", "Tagline", $hide_defaults=array("backcolor","hovercolor","bordercolor","radius","font","textcolor"), $additional_fields=array(), $info_text_overrides=array("text"=>eowbc_lang("Title line of the button widget section")) ), 
								array(
									'def_button'=>array(
				...
				'breadcrumb'=>array(
						'label'=>'Breadcrumb',
						'form'=>array_merge(\eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection( "breadcrumb", "Breadcrumb", $hide_defaults=array("hovercolor","bordercolor","text","font","textcolor"), $additional_fields=array( array("field_id"=>"breadcrumb_num_icon","field_label"=>eowbc_lang("Breadcrumb Number Icon"),"type"=>"color"), array("field_id"=>"breadcrumb_title","field_label"=>eowbc_lang("Breadcrumb Title"),"type"=>"color"), array("field_id"=>"breadcrumb_actions","field_label"=>eowbc_lang("Breadcrumb Actions"),"type"=>"color"), array("field_id"=>"showhide_icons","field_label"=>eowbc_lang("Breadcrumb Show/Hide Icons"),"type"=>"checkbox","options"=>array('1'=>' '),'attrs'=>array('is_id_as_name'=>true)) ), $info_text_overrides=array("showhide_icons"=>eowbc_lang('You can upload icon from configuration page, <a href="wp-admin/admin.php?page=eo-wbc-setting">click here</a> to go to configuration')), "active_inactive" ),
							array(
								'saved_tab_key'=>array(
									'type'=>'hidden',
									'value'=>'',
								...
								'appearance_breadcrumb_hide_border'=>array(
									...
									'is_id_as_name'=>true,
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('( Show/Hide breadcrumb border. )'),
										'type'=>'visible_info',
								...
								'appearance_breadcrumb_fixed_navigation'=>array(
									'label'=>eowbc_lang('Fixed navigation step'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
									...
									'is_id_as_name'=>true,
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('( check here if you wish to show steps as fixed layout. Example: \'Diamond\' stoods always first before \'Setting\' no matter if user begin with \'Setting\'. This setting applies to Step navigation only. )'),
										'type'=>'visible_info',
										'class'=>array('fluid', 'small'),
										'size_class'=>array('sixteen','wide'),
									),	
								...
								'appearance_breadcrumb_change_action_text'=>array(
									'label'=>eowbc_lang('Text for Change Action'),
									'type'=>'text',
									'sanitize'=>'sanitize_text_field',
									'value'=>'Change',
									'validate'=>array('required'=>''),
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('Specify the text that you want to show for change action of the breadcrumb step\'s item, default value is \'Change\''),
										'type'=>'visible_info',
										'class'=>array('fluid', 'small'),
										'size_class'=>array('sixteen','wide'),
									),	
								...
								'appearance_breadcrumb_wrap_mobile'=>array(
									'label'=>eowbc_lang('Wrap title on mobile'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
									'value'=>'',	//hiren commented the population from database here since it is meant to specify default only here. array(wbc()->options->get_option('appearance_breadcrumb','appearance_breadcrumb_hide_border')),
									'options'=>array('1'=>' '),
									'is_id_as_name'=>true,
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('( Wrap mobile breadcrumb title. )'),
										'type'=>'visible_info',
										'class'=>array('fluid', 'small'),
										'size_class'=>array('sixteen','wide'),
									),	
				...
				'filters'=>array(
						'label'=>'Filters',
						'form'=>array_merge( \eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection( "header", "Header", $hide_defaults=array("text","backcolor","hovercolor","bordercolor","radius"), $additional_fields=array(), $info_text_overrides=array("font"=>eowbc_lang("Font family to be used in filters"), "textcolor"=>eowbc_lang("Color for headers in filters widget") )), \eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection( "labels", eowbc_lang("Labels"), $hide_defaults=array("text","backcolor","hovercolor","bordercolor","radius","font"), $additional_fields=array(), $info_text_overrides=array("font"=>eowbc_lang("Font family to be used in filters") )),  \eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection( "rest_filters", "rest_filters", $hide_defaults=array("text","textcolor","backcolor","hovercolor","bordercolor","radius","font"), $additional_fields=array( array("field_id"=>"slider_nodes","field_label"=>eowbc_lang("Slider Nodes"),"type"=>"color"), array("field_id"=>"slider_track","field_label"=>eowbc_lang("Slider Track"),"type"=>"color"), array("field_id"=>"icon_size","field_label"=>"Icon Size","type"=>"text"), array("field_id"=>"icon_label_size","field_label"=>eowbc_lang("Icon Label Size"),"type"=>"text") ), $info_text_overrides=array("slider_track"=>eowbc_lang("Sets the specified color to slider's tracks between nodes"), "icon_size"=>eowbc_lang("Define size of icon at filter in px"), "icon_label_size"=>eowbc_lang("Define size of icon label in rem")), $special_type=null, $default_values = array("icon_size"=>"50px", "icon_label_size"=>"0.78571429rem") ),
							array(
								'appearance_filters_alternate_price_filter_first'=>array(
									'label'=>eowbc_lang('Alternate price slider(First Category)'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
									...
									'is_id_as_name'=>true,
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('( Alternate slider for price at first category. )'),
										'type'=>'visible_info',
										'class'=>array('fluid', 'small'),
										'size_class'=>array('sixteen','wide'),
									),	
								...
								'appearance_filters_alternate_price_filter_second'=>array(
									'label'=>eowbc_lang('Alternate price slider(Second Category)'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
									...
									'is_id_as_name'=>true,
									'class'=>array(),
									'visible_info'=>array( 'label'=>eowbc_lang('( Alternate slider for price at second category. )'),
										'type'=>'visible_info',
										'class'=>array('fluid', 'small'),
										'size_class'=>array('sixteen','wide'),
									),	
								...
								'appearance_filters_header_size'=>array(
									'label'=>eowbc_lang('Filter title size'),
									'type'=>'text',
									'sanitize'=>'sanitize_text_field',
									'value'=>'1em',						
									'class'=>array(),
								...
								'appearance_filters_table_head_border'=>array(
									'label'=>eowbc_lang('Table head border'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
								...
								'appearance_filters_loader'=>array(
									'label'=>eowbc_lang('Hide filter\'s loaded'),
									'type'=>'checkbox',
									'sanitize'=>'sanitize_text_field',
				...
				'product_page'=>array(
					...
					'form'=>array(
						...
						'product_page_add_to_basket'=>array(
							'label'=>eowbc_lang('Add to Basket Text'),
							'type'=>'text',
							/*'validate'=>array('required'=>''),*/
							'sanitize'=>'sanitize_text_field',
							...
							'class'=>array(),
							'size_class'=>array(),
							'visible_info'=>array( 'label'=>eowbc_lang('( Text to be shown as replacement to `Add to basket` text in dropdown button of add to bundle button. )'),
								'type'=>'visible_info',
								'class'=>array('fluid', 'small'),
								'size_class'=>array('sixteen','wide'),
							),	
						...
						'show_options_ui_in_pair_builder'=>array(
							'label'=>eowbc_lang('Show Option UI(swatches)'),
							'type'=>'checkbox',
							'sanitize'=>'sanitize_text_field',
							'value'=>array('1'),
							'options'=>array('1'=>' '),
							'is_id_as_name'=>true,
							'class'=>array(),
							'visible_info'=>array( 'label'=>eowbc_lang('If enabled options ui(swatches) will be displayed on item pages during builder process'),
								'type'=>'visible_info',
								'class'=>array('fluid', 'small'),
								'size_class'=>array('sixteen','wide'),
							),	
						...
						'show_spec_view_in_pair_builder'=>array(
							'label'=>eowbc_lang('Show Specification View'),
							'type'=>'checkbox',
							'sanitize'=>'sanitize_text_field',
							'value'=>array('1'),
							'options'=>array('1'=>' '),
							'is_id_as_name'=>true,
							'class'=>array(),
							'visible_info'=>array( 'label'=>eowbc_lang('If enabled specification view will be displayed on item pages during builder process'),
								'type'=>'visible_info',
								'class'=>array('fluid', 'small'),
								'size_class'=>array('sixteen','wide'),
							),	
