		...
		public static function get_form_definition($is_add_sample_values = false) {
			...
			$form_definition = array(
				'wid_btns' => array(
					...
					'form' => array_merge(
						array('appearence_button_widget_section' => array('label' => 'Appearence of Button Widget', 'type' => 'segment', 'desc' => 'Change the appearence of the Button Widget area.')),
						\eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection("tagline", "Tagline", $hide_defaults = array("backcolor", "hovercolor", "bordercolor", "radius", "font", "textcolor"), $additional_fields = array(), $info_text_overrides = array("text" => "Title line of the button widget section")),
						array(
							'def_button' => array(
								...
								'visible_info' => array(
									'label' => eowbc_lang('Use default button styling or custom styling'),
									'type' => 'visible_info',
									'class' => array('small'),
				...
				'breadcrumb' => array(
					'label' => 'Breadcrumb',
					'form' => array_merge(
						array('appearence_breadcrumb_section' => array('label' => 'Appearence of Breadcrumb', 'type' => 'segment', 'desc' => 'Change the appearence of the Breadcrumb.')),
						...
						array(
							...
							'appearance_breadcrumb_hide_border' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => '( Show/Hide breadcrumb border. )',
									'type' => 'visible_info',
							...
							'appearance_breadcrumb_fixed_navigation' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => '( check here if you wish to show steps as fixed layout. Example: \'Diamond\' stoods always first before \'Setting\' no matter if user begin with \'Setting\'. This setting applies to Step navigation only. )',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
							...
							'appearance_breadcrumb_change_action_text' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => 'Specify the text that you want to show for change action of the breadcrumb step\'s item, default value is \'Change\'',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
							...
							'appearance_breadcrumb_choose_prefix_text' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => 'set prefix on the breadcrumb which is by defauld `Choose a`',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
							...
							'appearance_breadcrumb_wrap_mobile' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => '( Wrap mobile breadcrumb title. )',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
				...
				'filters' => array(
					'label' => 'Filters',
					'form' => array_merge(
						array('appearence_filters_section' => array('label' => 'Appearence of Filters', 'type' => 'segment', 'desc' => 'Change the appearence of the Filters.')),
						\eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection("header", "Header", $hide_defaults = array("text", "backcolor", "hovercolor", "bordercolor", "radius"), $additional_fields = array(), $info_text_overrides = array("font" => "Font family to be used in filters", "textcolor" => "Color for headers in filters widget")),
						\eo\wbc\model\admin\Form_Builder::instance()->ui_controls_collection("labels", "Labels", $hide_defaults = array("text", "backcolor", "hovercolor", "bordercolor", "radius", "font"), $additional_fields = array(), $info_text_overrides = array("font" => "Font family to be used in filters")),
						...
						array(
							...
							'appearance_filters_alternate_price_filter_first' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => '( Alternate slider for price at first category. )',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
							...
							'appearance_filters_alternate_price_filter_second' => array(
								...
								'class' => array(),
								'visible_info' => array(
									'label' => '( Alternate slider for price at second category. )',
									'type' => 'visible_info',
									'class' => array('fluid', 'small'),
									'size_class' => array('sixteen', 'wide'),
								),
				...
				'product_page' => array(
					...
					'form' => array(
						...
						'fc_atc_button_text' => array(
							...
							'visible_info' => array(
								'label' => eowbc_lang('Text to be shown on add to cart button on product page for the first category'),
								'type' => 'visible_info',
								'class' => array('small'),
								// 'size_class'=>array('sixteen','wide'),
							),
						...
						'sc_atc_button_text' => array(
							...
							'visible_info' => array(
								'label' => eowbc_lang('Text to be shown on add to cart button on product page for the second category'),
								'type' => 'visible_info',
								'class' => array('small'),
								// 'size_class'=>array('sixteen','wide'),
							),
						...
						'product_page_add_to_basket' => array(
							...
							'size_class' => array(),
							'visible_info' => array(
								'label' => '( Text to be shown as replacement to `Add to basket` text in dropdown button of add to bundle button. )',
								'type' => 'visible_info',
								'class' => array('fluid', 'small'),
								'size_class' => array('sixteen', 'wide'),
							),
						...
						'show_options_ui_in_pair_builder' => array(
							...
							'class' => array(),
							'visible_info' => array(
								'label' => 'If enabled options ui(swatches) will be displayed on item pages during builder process',
								'type' => 'visible_info',
								'class' => array('fluid', 'small'),
								'size_class' => array('sixteen', 'wide'),
							),
						...
						'show_spec_view_in_pair_builder' => array(
							...
							'class' => array(),
							'visible_info' => array(
								'label' => 'If enabled specification view will be displayed on item pages during builder process',
								'type' => 'visible_info',
								'class' => array('fluid', 'small'),
								'size_class' => array('sixteen', 'wide'),
							),
				...
				'preview_page' => array(
					...
					'form' => array(
						...
						'enable_enquiry' => array(
							...
							'class' => array(),
							'visible_info' => array(
								'label' => 'If enabled the service by enquiry button will be set on the enquiry page only',
								'type' => 'visible_info',
								'class' => array('fluid', 'small'),
								'size_class' => array('sixteen', 'wide'),
							),
						),
						'show_cards_view' => array(
							'label' => 'Show Cards View on Preview Page',
							'type' => 'checkbox',
							'sanitize' => 'sanitize_text_field',
							'value' => array(),
							'options' => array('1' => ' '),
							...
							'class' => array(),
							'visible_info' => array(
								'label' => 'If enabled instead of the standard preview page the cards view will be disaplyed.',
								'type' => 'visible_info',
								'class' => array('fluid', 'small'),
								'size_class' => array('sixteen', 'wide'),
							),
				...
				'global' => array(
					...
					'form' => array(
						...
						'theme_primary_color_shade_light_90' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_90', '#333333', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
						...
						'theme_primary_color_shade_light_80' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_80', '#525252', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						// 	'sanitize' => 'sanitize_hex_color',
						// 	// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
						// 	'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_70', '#666666', false, true),
						// 	'is_id_as_name' => true,
						// 	'class' => array(),
						// 	'visible_info' => array(
						// 		'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						// 	),
						// ),
						// 'theme_secondary_color_shade_light_70' => array(
						// 	'label' => 'Theme Secondary Color Shade 70%',
						// 	'type' => 'color',
						// 	'sanitize' => 'sanitize_hex_color',
						// 	// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
						// 	'value' => wbc()->options->get_option('appearance_global', 'theme_secondary_color_shade_light_70', '#dcd7ca', false, true),
						// 	'is_id_as_name' => true,
						// 	'class' => array(),
						// 	'visible_info' => array(
						// 		'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Secondary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_60' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_60', '#666666', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_50' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_50', '#7a7a7a', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_40' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_40', '#929290', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						// 'theme_primary_color_shade_light_20' => array(
						// 	'label' => 'Theme Primary Color Shade 20%',
						// 	'type' => 'color',
						// 	'sanitize' => 'sanitize_hex_color',
						// 	// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
						// 	'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_20', '#929290', false, true),
						// 	'is_id_as_name' => true,
						// 	'class' => array(),
						// 	'visible_info' => array(
						// 		'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						// 	),
						// ),
						// 'theme_secondary_color_shade_light_20' => array(
						// 	'label' => 'Theme Secondary Color Shade 20%',
						// 	'type' => 'color',
						// 	'sanitize' => 'sanitize_hex_color',
						// 	// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
						// 	'value' => wbc()->options->get_option('appearance_global', 'theme_secondary_color_shade_light_20', '#f5f5f5', false, true),
						// 	'is_id_as_name' => true,
						// 	'class' => array(),
						// 	'visible_info' => array(
						// 		'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Secondary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_30' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_30', '#d9d1f4', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_20' => array(
							...
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_20', '#e1e1e1', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
						...
						'theme_primary_color_shade_light_10' => array(
							'label' => 'Theme Primary Color Shade 10%',
							'type' => 'color',
							'sanitize' => 'sanitize_hex_color',
							// NOTE: ama j default colour value set kari che te user expiriance mate che, jo user a ama koi chenge k set nai karu hoy to default value functionality ma considar nai thay means jo user a ama koi chenge k set nai karu hoy to a error apse. means e frontend ma or bije kai use nai thay means aa khali display mate che.
							'value' => wbc()->options->get_option('appearance_global', 'theme_primary_color_shade_light_10', '#efefef', false, true),
							'is_id_as_name' => true,
							'class' => array(),
							'visible_info' => array(
								'label' => 'If your theme means web site layout do not have the necessary shade for this field then simply select an appropriate light color shade of the Primary Color.(<strong>NOTE: The color shades specified here are for reference only and are not applied to the UI widgets by default. If you wish to apply these colors, you must manually update each field. Ensure that all fields are properly configured to reflect the desired colors in our plugin widgets.</strong>)',
