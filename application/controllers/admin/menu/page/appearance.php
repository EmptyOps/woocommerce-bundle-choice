			...
			$form_definition = array(
				...
				'product_page'=>array(
					...
					'form'=>array(
						...
						'product_page_add_to_basket_diamond'=>array(
							'label'=>'Add to Basket Text FIRST Category',
							'type'=>'text',							
							'sanitize'=>'sanitize_text_field',
							'value'=>wbc()->options->get_option('product_page','product_page_add_to_basket_diamond'),
							'class'=>array(),
							'size_class'=>array(),
							'visible_info'=>array( 'label'=>'( Text to be shown as replacement to `Add to basket` text in adjacent button of add to bundle button. )',
								'type'=>'visible_info',
								'class'=>array('fluid', 'small'),
								'size_class'=>array('sixteen','wide'),
							),	
						),
						'product_page_add_to_basket_ring'=>array(
							'label'=>'Add to Basket Text SECOND Category',
							'type'=>'text',							
							'sanitize'=>'sanitize_text_field',
							'value'=>wbc()->options->get_option('product_page','product_page_add_to_basket_ring'),							
							'class'=>array(),
							'size_class'=>array(),
							'visible_info'=>array( 'label'=>'( Text to be shown as replacement to `Add to basket` text in adjacent button of add to bundle button. )',
								'type'=>'visible_info',
