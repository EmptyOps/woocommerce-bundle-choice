  ...
  //       // Dokan Support
		...
		// ACTIVE_TODO_OC_END
					...
					// ACTIVE_TODO_OC_START
 					if( false ): 
					?>
					<select multiple="multiple" style="width:100%" data-placeholder="<?php echo esc_attr( 'Select terms', 'woo-bundle-choice' ); ?>" class="dokan_attribute_values dokan-select2" name="attribute_values[<?php echo esc_attr( $i ); ?>][]">
						<?php
					...
					<div class="dokan-pre-defined-attribute-btn-group">
						<button class="dokan-btn dokan-btn-default plus dokan-select-all-attributes"><?php esc_html_e( 'Select all', 'woo-bundle-choice' ); ?></button>
						<button class="dokan-btn dokan-btn-default minus dokan-select-no-attributes"><?php esc_html_e( 'Select none', 'woo-bundle-choice' ); ?></button>
					</div>
					<?php
					endif;
					// ACTIVE_TODO_OC_END 		
