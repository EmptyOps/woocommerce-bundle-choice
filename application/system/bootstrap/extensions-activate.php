<?php
/**
 *	Extensions activate class 
 *  This class handles and take care of common logic for extensions activate process 
...
if ( ! class_exists( 'Extensions_Activate' ) ) {

	class Extensions_Activate extends Activate {
		...
		public function run() {
			...
			//TODO implement the below setup wizard flow for extensions 
			add_action( 'activated_plugin',function($plugin){
				if( in_array($plugin,array('sp-extension-folder/index-or-main-file.php','sp-extension-1-folder/index-or-main-file.php') ) ) {
					...
					$eo_wbc_inventory_type = wbc()->options->get_option('_system','sp_ext_'.$plugin.'_setup_wizard_run', false);
					if( empty($eo_wbc_inventory_type) ) {
						//add admin page
			           exit(wp_redirect( admin_url('admin.php?page=sp-extension-page&wbc_ext_setup=1')));            
					}		
				}			
			});
