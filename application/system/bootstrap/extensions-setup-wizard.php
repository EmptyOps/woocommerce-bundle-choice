<?php
/**
 *	Extensions setup wizard class 
 *  This class handles and take care of common logic for extensions setup wizard process 
...
if ( ! class_exists( 'Extensions_Setup_Wizard' ) ) {

	class Extensions_Setup_Wizard extends Setup_Wizard {
		...
		public function build_setup_page() {
			...
			// return since not implemented yet for this extensions class 
			return false;
...
add_action('admin_init',function(){
	Extensions_Setup_Wizard::instance()->init();
});
