...
/*!********************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/api/factory.js ***!
  \********************************************************************/
/*! exports provided: createBlock, cloneBlock, isWildcardBlockTransform, isContainerGroupBlock, isBlockSelectionOfSameType, getPossibleBlockTransformations, findTransform, getBlockTransforms, switchToBlockType, getBlockFromExample */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function createBlock(name) {
  ...
  var sanitizedAttributes = Object(lodash__WEBPACK_IMPORTED_MODULE_3__["reduce"])(blockType.attributes, function (accumulator, schema, key) {
...
var getBlockFromExample = function getBlockFromExample(name, example) {
  return createBlock(name, example.attributes, Object(lodash__WEBPACK_IMPORTED_MODULE_3__["map"])(example.innerBlocks, function (innerBlock) {
...
/*!******************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/api/index.js ***!
  \******************************************************************/
/*! exports provided: createBlock, cloneBlock, getPossibleBlockTransformations, switchToBlockType, getBlockTransforms, findTransform, getBlockFromExample, parse, getBlockAttributes, parseWithAttributeSchema, pasteHandler, rawHandler, getPhrasingContentSchema, serialize, getBlockContent, getBlockDefaultClassName, getBlockMenuDefaultClassName, getSaveElement, getSaveContent, isValidBlockContent, getCategories, setCategories, updateCategory, registerBlockType, registerBlockCollection, unregisterBlockType, setFreeformContentHandlerName, getFreeformContentHandlerName, setUnregisteredTypeHandlerName, getUnregisteredTypeHandlerName, setDefaultBlockName, getDefaultBlockName, setGroupingBlockName, getGroupingBlockName, getBlockType, getBlockTypes, getBlockSupport, hasBlockSupport, isReusableBlock, getChildBlockNames, hasChildBlocks, hasChildBlocksWithInserterSupport, unstable__bootstrapServerSideBlockDefinitions, registerBlockStyle, unregisterBlockStyle, registerBlockVariation, unregisterBlockVariation, isUnmodifiedDefaultBlock, normalizeIconObject, isValidIcon, __experimentalGetBlockLabel, __experimentalGetAccessibleBlockLabel, doBlocksMatchTemplate, synchronizeBlocksWithTemplate, children, node */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "registerBlockCollection", function() { return _registration__WEBPACK_IMPORTED_MODULE_6__["registerBlockCollection"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "registerBlockVariation", function() { return _registration__WEBPACK_IMPORTED_MODULE_6__["registerBlockVariation"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "unregisterBlockVariation", function() { return _registration__WEBPACK_IMPORTED_MODULE_6__["unregisterBlockVariation"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "__experimentalGetBlockLabel", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__["getBlockLabel"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "__experimentalGetAccessibleBlockLabel", function() { return _utils__WEBPACK_IMPORTED_MODULE_7__["getAccessibleBlockLabel"]; });
...
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./validation */ "./node_modules/@wordpress/blocks/build-module/api/validation/index.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/blocks/build-module/api/utils.js");
...
function isFigureContent(node, schema) {
  ...
  if (tag === 'figcaption' || Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_1__["isTextContent"])(node)) {
    return false;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (function (node) {
  ...
  if (newData[0] === ' ') {
    var previousSibling = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getSibling"])(node, 'previous');
  ...
  if (newData[newData.length - 1] === ' ') {
    var nextSibling = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getSibling"])(node, 'next');
...
/*!*******************************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/api/raw-handling/index.js ***!
  \*******************************************************************************/
/*! exports provided: pasteHandler, getPhrasingContentSchema, rawHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _parser__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../parser */ "./node_modules/@wordpress/blocks/build-module/api/parser.js");
/* harmony import */ var _normalise_blocks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./normalise-blocks */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/normalise-blocks.js");
/* harmony import */ var _special_comment_converter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./special-comment-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/special-comment-converter.js");
...
/* harmony import */ var _blockquote_normaliser__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./blockquote-normaliser */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/blockquote-normaliser.js");
...
/* harmony import */ var _shortcode_converter__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shortcode-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/shortcode-converter.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js");
/* harmony import */ var _phrasing_content__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./phrasing-content */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/phrasing-content.js");
...
/* harmony import */ var _paste_handler__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./paste-handler */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/paste-handler.js");
...
function rawHandler(_ref3) {
  ...
  var phrasingContentSchema = Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_11__["getPhrasingContentSchema"])();
  var blockContentSchema = Object(_utils__WEBPACK_IMPORTED_MODULE_10__["getBlockContentSchema"])(rawTransforms, phrasingContentSchema);
...
function isInline(node, contextTag) {
  if (Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_1__["isTextContent"])(node)) {
    return true;
  }
...
/* harmony import */ var _comment_remover__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./comment-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/comment-remover.js");
/* harmony import */ var _is_inline_content__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./is-inline-content */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/is-inline-content.js");
/* harmony import */ var _phrasing_content_reducer__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./phrasing-content-reducer */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/phrasing-content-reducer.js");
/* harmony import */ var _head_remover__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./head-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/head-remover.js");
...
/* harmony import */ var _list_reducer__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./list-reducer */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/list-reducer.js");
/* harmony import */ var _image_corrector__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./image-corrector */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/image-corrector.js");
/* harmony import */ var _blockquote_normaliser__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./blockquote-normaliser */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/blockquote-normaliser.js");
/* harmony import */ var _figure_content_reducer__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./figure-content-reducer */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/figure-content-reducer.js");
/* harmony import */ var _shortcode_converter__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./shortcode-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/shortcode-converter.js");
/* harmony import */ var _markdown_converter__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./markdown-converter */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/markdown-converter.js");
/* harmony import */ var _iframe_remover__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./iframe-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/iframe-remover.js");
/* harmony import */ var _google_docs_uid_remover__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./google-docs-uid-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/google-docs-uid-remover.js");
/* harmony import */ var _html_formatting_remover__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./html-formatting-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/html-formatting-remover.js");
/* harmony import */ var _br_remover__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./br-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/br-remover.js");
/* harmony import */ var _phrasing_content__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./phrasing-content */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/phrasing-content.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js");
/* harmony import */ var _empty_paragraph_remover__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./empty-paragraph-remover */ "./node_modules/@wordpress/blocks/build-module/api/raw-handling/empty-paragraph-remover.js");
...
function filterInlineHTML(HTML) {
  HTML = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["deepFilterHTML"])(HTML, [_google_docs_uid_remover__WEBPACK_IMPORTED_MODULE_20__["default"], _phrasing_content_reducer__WEBPACK_IMPORTED_MODULE_10__["default"], _comment_remover__WEBPACK_IMPORTED_MODULE_8__["default"]]);
  HTML = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["removeInvalidHTML"])(HTML, Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_23__["getPhrasingContentSchema"])('paste'), {
    inline: true
  });
  HTML = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["deepFilterHTML"])(HTML, [_html_formatting_remover__WEBPACK_IMPORTED_MODULE_21__["default"], _br_remover__WEBPACK_IMPORTED_MODULE_22__["default"]]); // Allows us to ask for this information when we get a report.
...
function htmlToBlocks(_ref) {
  ...
  return Array.from(doc.body.children).map(function (node) {
    ...
    if (!rawTransform) {
      return Object(_factory__WEBPACK_IMPORTED_MODULE_2__["createBlock"])( // Should not be hardcoded.
      'core/html', Object(_parser__WEBPACK_IMPORTED_MODULE_5__["getBlockAttributes"])('core/html', node.outerHTML));
    }
    ...
    return Object(_factory__WEBPACK_IMPORTED_MODULE_2__["createBlock"])(blockName, Object(_parser__WEBPACK_IMPORTED_MODULE_5__["getBlockAttributes"])(blockName, node.outerHTML));
  });
}
/**
...
function pasteHandler(_ref3) {
  ...
  if (mode !== 'INLINE') {
    ...
    if (content.indexOf('<!-- wp:') !== -1) {
      return Object(_parser__WEBPACK_IMPORTED_MODULE_5__["parseWithGrammar"])(content);
    }
  ...
  if (plainText && (!HTML || Object(_utils__WEBPACK_IMPORTED_MODULE_24__["isPlain"])(HTML))) {
    HTML = Object(_markdown_converter__WEBPACK_IMPORTED_MODULE_18__["default"])(plainText); // Switch to inline mode if:
  ...
  var pieces = Object(_shortcode_converter__WEBPACK_IMPORTED_MODULE_17__["default"])(HTML); // The call to shortcodeConverter will always return more than one element
  ...
  var rawTransforms = getRawTransformations();
  var phrasingContentSchema = Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_23__["getPhrasingContentSchema"])('paste');
  var blockContentSchema = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["getBlockContentSchema"])(rawTransforms, phrasingContentSchema, true);
  var blocks = Object(lodash__WEBPACK_IMPORTED_MODULE_1__["compact"])(Object(lodash__WEBPACK_IMPORTED_MODULE_1__["flatMap"])(pieces, function (piece) {
    ...
    var filters = [_google_docs_uid_remover__WEBPACK_IMPORTED_MODULE_20__["default"], _ms_list_converter__WEBPACK_IMPORTED_MODULE_12__["default"], _head_remover__WEBPACK_IMPORTED_MODULE_11__["default"], _list_reducer__WEBPACK_IMPORTED_MODULE_13__["default"], _image_corrector__WEBPACK_IMPORTED_MODULE_14__["default"], _phrasing_content_reducer__WEBPACK_IMPORTED_MODULE_10__["default"], _special_comment_converter__WEBPACK_IMPORTED_MODULE_7__["default"], _comment_remover__WEBPACK_IMPORTED_MODULE_8__["default"], _figure_content_reducer__WEBPACK_IMPORTED_MODULE_16__["default"], _blockquote_normaliser__WEBPACK_IMPORTED_MODULE_15__["default"]];

    if (!canUserUseUnfilteredHTML) {
      // Should run before `figureContentReducer`.
      filters.unshift(_iframe_remover__WEBPACK_IMPORTED_MODULE_19__["default"]);
    }

    var schema = _objectSpread({}, blockContentSchema, {}, phrasingContentSchema);

    piece = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["deepFilterHTML"])(piece, filters, blockContentSchema);
    piece = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["removeInvalidHTML"])(piece, schema);
    piece = Object(_normalise_blocks__WEBPACK_IMPORTED_MODULE_6__["default"])(piece);
    piece = Object(_utils__WEBPACK_IMPORTED_MODULE_24__["deepFilterHTML"])(piece, [_html_formatting_remover__WEBPACK_IMPORTED_MODULE_21__["default"], _br_remover__WEBPACK_IMPORTED_MODULE_22__["default"], _empty_paragraph_remover__WEBPACK_IMPORTED_MODULE_25__["default"]], blockContentSchema); // Allows us to ask for this information when we get a report.
  ...
  if (mode === 'AUTO' && blocks.length === 1 && Object(_registration__WEBPACK_IMPORTED_MODULE_3__["hasBlockSupport"])(blocks[0].name, '__unstablePasteTextInline', false)) {
    ...
    if (trimmedPlainText !== '' && trimmedPlainText.indexOf('\n') === -1) {
      return Object(_utils__WEBPACK_IMPORTED_MODULE_24__["removeInvalidHTML"])(Object(_serializer__WEBPACK_IMPORTED_MODULE_4__["getBlockContent"])(blocks[0]), phrasingContentSchema);
    }
  }
...
/* harmony default export */ __webpack_exports__["default"] = (function (node, doc) {
  ...
  if (node.nodeName === 'SPAN' && node.style) {
    ...
    if (fontWeight === 'bold' || fontWeight === '700') {
      Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["wrap"])(doc.createElement('strong'), node);
    }

    if (fontStyle === 'italic') {
      Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["wrap"])(doc.createElement('em'), node);
    ...
    if (textDecorationLine === 'line-through' || Object(lodash__WEBPACK_IMPORTED_MODULE_0__["includes"])(textDecoration, 'line-through')) {
      Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["wrap"])(doc.createElement('s'), node);
    }

    if (verticalAlign === 'super') {
      Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["wrap"])(doc.createElement('sup'), node);
    } else if (verticalAlign === 'sub') {
      Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["wrap"])(doc.createElement('sub'), node);
    }
  } else if (node.nodeName === 'B') {
    node = Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["replaceTag"])(node, 'strong');
  } else if (node.nodeName === 'I') {
    node = Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_1__["replaceTag"])(node, 'em');
...
function getPhrasingContentSchema(context) {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_1__["omit"])(_objectSpread({}, phrasingContentSchema, {
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  var transformation = Object(_factory__WEBPACK_IMPORTED_MODULE_4__["findTransform"])(transformsFrom, function (transform) {
    return excludedBlockNames.indexOf(transform.blockName) === -1 && transform.type === 'shortcode' && Object(lodash__WEBPACK_IMPORTED_MODULE_2__["some"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["castArray"])(transform.tag), function (tag) {
  ...
  var transformTag = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["find"])(transformTags, function (tag) {
    return Object(_wordpress_shortcode__WEBPACK_IMPORTED_MODULE_3__["regexp"])(tag).test(HTML);
  });
  var match;
  ...
  if (match = Object(_wordpress_shortcode__WEBPACK_IMPORTED_MODULE_3__["next"])(transformTag, HTML, lastIndex)) {
    ...
    if (transformation.isMatch && !transformation.isMatch(match.shortcode.attrs)) {
      return segmentHTMLToShortcodeBlock(HTML, previousIndex, [].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(excludedBlockNames), [transformation.blockName]));
    }
    ...
    var block = Object(_factory__WEBPACK_IMPORTED_MODULE_4__["createBlock"])(transformation.blockName, Object(_parser__WEBPACK_IMPORTED_MODULE_6__["getBlockAttributes"])(_objectSpread({}, Object(_registration__WEBPACK_IMPORTED_MODULE_5__["getBlockType"])(transformation.blockName), {
      attributes: transformation.attributes
    }), match.shortcode.content, attributes));
    return [beforeHTML, block].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(segmentHTMLToShortcodeBlock(HTML.substr(lastIndex))));
  }
...
/*!*******************************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/api/raw-handling/utils.js ***!
  \*******************************************************************************/
/*! exports provided: getBlockContentSchema, isEmpty, isPlain, deepFilterNodeList, deepFilterHTML, removeInvalidHTML, getSibling */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function getBlockContentSchema(transforms, phrasingContentSchema, isPaste) {
  var schemas = transforms.map(function (_ref) {
    var isMatch = _ref.isMatch,
        ...
        schema = _ref.schema;
    var hasAnchorSupport = Object(___WEBPACK_IMPORTED_MODULE_4__["hasBlockSupport"])(blockName, 'anchor');
    schema = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isFunction"])(schema) ? schema({
...
function getSibling(node, which) {
  ...
  if (sibling && Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_5__["isPhrasingContent"])(sibling)) {
    return sibling;
  }

  var parentNode = node.parentNode;

  if (!parentNode || !Object(_phrasing_content__WEBPACK_IMPORTED_MODULE_5__["isPhrasingContent"])(parentNode)) {
    return;
  }
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./constants */ "./node_modules/@wordpress/blocks/build-module/api/constants.js");
...
function registerBlockType(name, settings) {
  ...
  if (settings.deprecated) {
    settings.deprecated = settings.deprecated.map(function (deprecation) {
      ...
      // present don't fail.
      _objectSpread({}, Object(lodash__WEBPACK_IMPORTED_MODULE_1__["omit"])(preFilterSettings, _constants__WEBPACK_IMPORTED_MODULE_5__["DEPRECATED_ENTRY_KEYS"]), {}, deprecation), name), _constants__WEBPACK_IMPORTED_MODULE_5__["DEPRECATED_ENTRY_KEYS"]);
    });
  }
...
function registerBlockCollection(namespace, _ref) {
  var title = _ref.title,
      icon = _ref.icon;
  Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["dispatch"])('core/blocks').addBlockCollection(namespace, title, icon);
}
/**
...
function unregisterBlockCollection(namespace) {
  Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["dispatch"])('core/blocks').removeBlockCollection(namespace);
}
/**
 * Unregisters a block.
 *
...
var registerBlockVariation = function registerBlockVariation(blockName, variation) {
  Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["dispatch"])('core/blocks').addBlockVariations(blockName, variation);
};
/**
...
var unregisterBlockVariation = function unregisterBlockVariation(blockName, variationName) {
  Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_3__["dispatch"])('core/blocks').removeBlockVariations(blockName, variationName);
};
...
function getSaveElement(blockTypeOrName, attributes) {
  ...
  if (Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isObject"])(element) && Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__["hasFilter"])('blocks.getSaveContent.extraProps')) {
     ...
     * @param {Object}  attributes Block attributes.
     */
    var props = Object(_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__["applyFilters"])('blocks.getSaveContent.extraProps', _objectSpread({}, element.props), blockType, attributes);
...
function getCommentAttributes(blockType, attributes) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["reduce"])(blockType.attributes, function (accumulator, attributeSchema, key) {
...
/*!******************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/api/utils.js ***!
  \******************************************************************/
/*! exports provided: isUnmodifiedDefaultBlock, isValidIcon, normalizeIconObject, normalizeBlockType, getBlockLabel, getAccessibleBlockLabel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
function isUnmodifiedDefaultBlock(block) {
  ...
  if (!isUnmodifiedDefaultBlock.block || isUnmodifiedDefaultBlock.block.name !== defaultBlockName) {
    isUnmodifiedDefaultBlock.block = Object(_factory__WEBPACK_IMPORTED_MODULE_7__["createBlock"])(defaultBlockName);
  }

  var newDefaultBlock = isUnmodifiedDefaultBlock.block;
  var blockType = Object(_registration__WEBPACK_IMPORTED_MODULE_6__["getBlockType"])(defaultBlockName);
...
function getBlockLabel(blockType, attributes) {
  ...
  return Object(_wordpress_dom__WEBPACK_IMPORTED_MODULE_5__["__unstableStripHTML"])(label);
}
/**
...
function getAccessibleBlockLabel(blockType, attributes, position) {
  ...
  if (hasPosition && direction === 'vertical') {
    if (hasLabel) {
      return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
      /* translators: accessibility text. %1: The block title, %2: The block row number, %3: The block label.. */
      Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%1$s Block. Row %2$d. %3$s'), title, position, label);
    }

    return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
    /* translators: accessibility text. %s: The block title, %d The block row number. */
    Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%s Block. Row %d'), title, position);
  } else if (hasPosition && direction === 'horizontal') {
    if (hasLabel) {
      return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
      /* translators: accessibility text. %1: The block title, %2: The block column number, %3: The block label.. */
      Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%1$s Block. Column %2$d. %3$s'), title, position, label);
    }

    return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
    /* translators: accessibility text. %s: The block title, %d The block column number. */
    Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%s Block. Column %d'), title, position);
  }

  if (hasLabel) {
    return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
    /* translators: accessibility text. %1: The block title. %2: The block label. */
    Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%1$s Block. %2$s'), title, label);
  }

  return Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["sprintf"])(
  /* translators: accessibility text. %s: The block title. */
  Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('%s Block'), title);
}
...
/* harmony import */ var _logger__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./logger */ "./node_modules/@wordpress/blocks/build-module/api/validation/logger.js");
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils */ "./node_modules/@wordpress/blocks/build-module/api/utils.js");
...
function isEqualTagAttributePairs(actual, expected) {
  ...
  for (var _i = 0; _i < actual.length; _i++) {
    var _actual$_i = Object(_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_3__["default"])(actual[_i], 2),
        name = _actual$_i[0],
...
/*!**********************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/store/actions.js ***!
  \**********************************************************************/
/*! exports provided: addBlockTypes, removeBlockTypes, addBlockStyles, removeBlockStyles, addBlockVariations, removeBlockVariations, setDefaultBlockName, setFreeformFallbackBlockName, setUnregisteredFallbackBlockName, setGroupingBlockName, setCategories, updateCategory, addBlockCollection, removeBlockCollection */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!**********************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/store/reducer.js ***!
  \**********************************************************************/
/*! exports provided: DEFAULT_CATEGORIES, blockTypes, blockStyles, blockVariations, createBlockNameSetterReducer, defaultBlockName, freeformFallbackBlockName, unregisteredFallbackBlockName, groupingBlockName, categories, collections, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var DEFAULT_CATEGORIES = [{
  slug: 'common',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Common blocks')
}, {
  slug: 'formatting',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Formatting')
}, {
  slug: 'layout',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Layout elements')
}, {
  slug: 'widgets',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Widgets')
}, {
  slug: 'embed',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Embeds')
}, {
  slug: 'reusable',
  title: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__["__"])('Reusable blocks')
}];
/**
...
function blockTypes() {
  ...
  switch (action.type) {
    case 'ADD_BLOCK_TYPES':
      return _objectSpread({}, state, {}, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["keyBy"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(action.blockTypes, function (blockType) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["omit"])(blockType, 'styles ');
      }), 'name'));

    case 'REMOVE_BLOCK_TYPES':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["omit"])(state, action.names);
  }
...
function blockStyles() {
  ...
  switch (action.type) {
    case 'ADD_BLOCK_TYPES':
      return _objectSpread({}, state, {}, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["mapValues"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["keyBy"])(action.blockTypes, 'name'), function (blockType) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniqBy"])([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(blockType, ['styles'], [])), Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [blockType.name], []))), function (style) {
          return style.name;
        });
      }));

    case 'ADD_BLOCK_STYLES':
      return _objectSpread({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action.blockName, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniqBy"])([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [action.blockName], [])), Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(action.styles)), function (style) {
        return style.name;
      })));

    case 'REMOVE_BLOCK_STYLES':
      return _objectSpread({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action.blockName, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["filter"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [action.blockName], []), function (style) {
...
function blockVariations() {
  ...
  switch (action.type) {
    case 'ADD_BLOCK_TYPES':
      return _objectSpread({}, state, {}, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["mapValues"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["keyBy"])(action.blockTypes, 'name'), function (blockType) {
        return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniqBy"])([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(blockType, ['variations'], [])), Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [blockType.name], []))), function (variation) {
          return variation.name;
        });
      }));

    case 'ADD_BLOCK_VARIATIONS':
      return _objectSpread({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action.blockName, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["uniqBy"])([].concat(Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [action.blockName], [])), Object(_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_0__["default"])(action.variations)), function (variation) {
        return variation.name;
      })));

    case 'REMOVE_BLOCK_VARIATIONS':
      return _objectSpread({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action.blockName, Object(lodash__WEBPACK_IMPORTED_MODULE_2__["filter"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(state, [action.blockName], []), function (variation) {
...
function categories() {
  ...
  switch (action.type) {
    ...
    case 'UPDATE_CATEGORY':
      {
        if (!action.category || Object(lodash__WEBPACK_IMPORTED_MODULE_2__["isEmpty"])(action.category)) {
          return state;
        }

        var categoryToChange = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["find"])(state, ['slug', action.slug]);

        if (categoryToChange) {
          return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(state, function (category) {
...
function collections() {
  ...
  switch (action.type) {
    case 'ADD_BLOCK_COLLECTION':
      return _objectSpread({}, state, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__["default"])({}, action.namespace, {
        title: action.title,
        icon: action.icon
      }));

    case 'REMOVE_BLOCK_COLLECTION':
      return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["omit"])(state, action.namespace);
  }
...
/*!************************************************************************!*\
  !*** ./node_modules/@wordpress/blocks/build-module/store/selectors.js ***!
  \************************************************************************/
/*! exports provided: getBlockTypes, getBlockType, getBlockStyles, getBlockVariations, getDefaultBlockVariation, getCategories, getCollections, getDefaultBlockName, getFreeformFallbackBlockName, getUnregisteredFallbackBlockName, getGroupingBlockName, getChildBlockNames, getBlockSupport, hasBlockSupport, isMatchingSearchTerm, hasChildBlocks, hasChildBlocksWithInserterSupport */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var getBlockTypes = Object(rememo__WEBPACK_IMPORTED_MODULE_1__["default"])(function (state) {
...
function getDefaultBlockVariation(state, blockName, scope) {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["findLast"])(variations, 'isDefault') || Object(lodash__WEBPACK_IMPORTED_MODULE_2__["first"])(variations);
}
/**
...
var getChildBlockNames = Object(rememo__WEBPACK_IMPORTED_MODULE_1__["default"])(function (state, blockName) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["map"])(Object(lodash__WEBPACK_IMPORTED_MODULE_2__["filter"])(state.blockTypes, function (blockType) {
    return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["includes"])(blockType.parent, blockName);
  }), function (_ref) {
    var name = _ref.name;
    return name;
  });
...
var getBlockSupport = function getBlockSupport(state, nameOrType, feature, defaultSupports) {
  ...
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["get"])(blockType, ['supports', feature], defaultSupports);
};
/**
 * Returns true if the block defines support for a feature, or false otherwise.
 *
...
function isMatchingSearchTerm(state, nameOrType, searchTerm) {
  var blockType = getNormalizedBlockType(state, nameOrType);
  var getNormalizedSearchTerm = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["flow"])([// Disregard diacritics.
  //  Input: "média"
  lodash__WEBPACK_IMPORTED_MODULE_2__["deburr"], // Lowercase.
  //  Input: "MEDIA"
  function (term) {
  ...
  var isSearchMatch = Object(lodash__WEBPACK_IMPORTED_MODULE_2__["flow"])([getNormalizedSearchTerm, function (normalizedCandidate) {
    return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["includes"])(normalizedCandidate, normalizedSearchTerm);
  }]);
  return isSearchMatch(blockType.title) || Object(lodash__WEBPACK_IMPORTED_MODULE_2__["some"])(blockType.keywords, isSearchMatch) || isSearchMatch(blockType.category);
}
/**
 * Returns a boolean indicating if a block has child blocks or not.
 *
...
var hasChildBlocksWithInserterSupport = function hasChildBlocksWithInserterSupport(state, blockName) {
  return Object(lodash__WEBPACK_IMPORTED_MODULE_2__["some"])(getChildBlockNames(state, blockName), function (childBlockName) {
