...
/*!************************************************************!*\
  !*** ./node_modules/@wordpress/data/build-module/index.js ***!
  \************************************************************/
/*! exports provided: withSelect, withDispatch, withRegistry, RegistryProvider, RegistryConsumer, useRegistry, useSelect, useDispatch, __unstableUseDispatchWithMap, AsyncModeProvider, createRegistry, createRegistrySelector, createRegistryControl, plugins, combineReducers, select, __experimentalResolveSelect, dispatch, subscribe, registerGenericStore, registerStore, use */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "__unstableUseDispatchWithMap", function() { return _components_use_dispatch__WEBPACK_IMPORTED_MODULE_8__["useDispatchWithMap"]; });
...
function createNamespace(key, options, registry) {
  ...
  var resolvers;
  var actions = mapActions(_objectSpread({}, _metadata_actions__WEBPACK_IMPORTED_MODULE_11__, {}, options.actions), store);
  var selectors = mapSelectors(_objectSpread({}, Object(lodash__WEBPACK_IMPORTED_MODULE_4__["mapValues"])(_metadata_selectors__WEBPACK_IMPORTED_MODULE_10__, function (selector) {
...
function createPersistenceInterface(options) {
  ...
  function setData(key, value) {
    data = _objectSpread({}, data, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, key, value));
  ...
  return {
    getSelectors: function getSelectors() {
      return ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'isResolving', 'getCachedResolvers'].reduce(function (memo, selectorName) {
        return _objectSpread({}, memo, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, selectorName, getCoreDataSelector(selectorName)));
      }, {});
    },
    getActions: function getActions() {
      return ['startResolution', 'finishResolution', 'invalidateResolution', 'invalidateResolutionForStore', 'invalidateResolutionForStoreSelector'].reduce(function (memo, actionName) {
        return _objectSpread({}, memo, Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, actionName, getCoreDataAction(actionName)));
      }, {});
    },
