...
class f_i_step1Cest
{
  ...
  //       }
		...
		$I->click( $suite_name_prefix == "n_" ? '//*[@id="eo_wbc_add_to_cart"]' : 'Add to bag...' );	// click( $suite_name_prefix == "n_" ? $I->get_configs('first_product_page_button_text',$suite_name_prefix) : 'Add to bag...' );
