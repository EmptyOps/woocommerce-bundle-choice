...
if(false and !in_array($variable_item_data['options_loop_type'][$term->slug],array('dropdown_image','dropdown_image_only','dropdown'))) {                 
    ...
    $template = array(
        ...
        'class' => array(   'ui',
                            ...
                            'spui-wbc-swatches-variable-item-'.esc_attr($variable_item_data['options_loop_type'][$term->slug]),
                            'spui-wbc-swatches-variable-item-header',
                            'spui-wbc-swatches-variable-item-'.esc_attr($variable_item_data['options_loop_type'][$term->slug]).'-header',
