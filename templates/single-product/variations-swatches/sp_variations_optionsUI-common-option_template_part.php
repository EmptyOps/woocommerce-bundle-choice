...
$template_inner = wbc()->load->template($template_sub_dir.'/'.$woo_dropdown_attribute_html_data['type'], array('args'=>$woo_dropdown_attribute_html_data['args'],'term'=>$term,'type'=>$variable_item_data['options_loop_type'][$term->slug]),true,'wbc',true);
