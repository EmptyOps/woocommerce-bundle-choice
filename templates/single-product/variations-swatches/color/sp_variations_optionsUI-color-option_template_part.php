...
$template = array(
    'type' => 'div',
    'class' => $woo_dropdown_attribute_html_data['class'].' '.$woo_dropdown_attribute_html_data['options_loop_class'][$slug_or_option].' variable-item-color-fill variable-item-span-'.esc_attr( $variable_item_data['options_loop_type'][$slug_or_option] ),
