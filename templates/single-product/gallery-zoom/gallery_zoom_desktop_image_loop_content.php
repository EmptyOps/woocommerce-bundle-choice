...
if(empty($image['extra_params_org']['type']) || $image['extra_params_org']['type'] == 'image' ) {
    ...
    $template = array(
        'type' => 'image',
        'class' => array('img-fluid','big-img',esc_attr( $image['class'] ), 'img-item', 'img-item-'.$image['extra_params_org']['type'], 'img-item-'.$image['extra_params_org']['type'].'-'.wbc()->common->current_theme_key(), 'sp-variations-gallery-images-zoom-loader'),
        'src' => $image['src'],
