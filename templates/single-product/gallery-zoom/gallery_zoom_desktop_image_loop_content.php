...
if(empty($image['extra_params_org']['type']) || $image['extra_params_org']['type'] == 'image' ) {
    ...
    $template = array(
        'type' => 'image',
        'class' => array('img-fluid','big-img',esc_attr( $image['class'] ), 'img-item', 'img-item-'.$image['extra_params_org']['type'], 'img-item-'.$image['extra_params_org']['type'].'-'.wbc()->common->sp_wbc_current_theme_key() ),
        'src' => $image['src'],
    ...
    if ( $image['extra_params_org']['type'] == 'video' or $image['extra_params_org']['type'] == 'video_url' ) {
        if ( $image['extra_params_org']['type'] == 'video' and isset( $image['extra_params_org']['embed_type'] ) && $image['extra_params_org']['embed_type'] === 'iframe' ) {
            ...
            $template = array(
                'type' => 'div',
                'class' => array('spui_iframes_video_container',esc_attr( $image['class'] ), 'img-item', 'img-item-'.$image['extra_params_org']['type'], 'img-item-'.$image['extra_params_org']['type'].'-'.wbc()->common->sp_wbc_current_theme_key() ),
                'child' => array(
                    array(
                        'type' => 'iframe',
                        'src' => $image['video_src'],
        ...
        if ( $image['extra_params_org']['type'] == 'video' and isset( $image['extra_params_org']['embed_type'] ) && $image['extra_params_org']['embed_type'] === 'video' ) {
            ...
            $template = array(
                'type' => 'div',
                'class' => array('spui_video_container',esc_attr( $image['class'] ), 'img-item', 'img-item-'.$image['extra_params_org']['type'], 'img-item-'.$image['extra_params_org']['type'].'-'.wbc()->common->sp_wbc_current_theme_key() ),
                'child' => array(
                    array(
                        'type' => 'video',
