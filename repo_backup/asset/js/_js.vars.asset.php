...
add_action( ( !is_admin() ? 'wp_enqueue_scripts' : 'admin_enqueue_scripts'),function(){
	...
	if( is_admin() ){
		// add_action('wp_enqueue_scripts',function(){
			...
			$window_document_splugins_admin_is_legacy_admin_page = ((apply_filters('sp_is_legacy_admin_page', true)) ? "true" : "false");

			$inline_script = "
			window.document.splugins.common.is_admin = ".$window_document_splugins_common_is_admin.";
			window.document.splugins.admin.is_legacy_admin_page =".$window_document_splugins_admin_is_legacy_admin_page.";
			";	
			wp_add_inline_script ('jquery',$inline_script);
	...
	// add_action('wp_enqueue_scripts',function(){
		...
		$window_document_splugins_common_current_theme_key = wbc()->common->current_theme_key();
		$window_document_splugins_common_is_shop_page = ((is_shop()) ? "true" : "false");
		$window_document_splugins_common_is_category_page = ((is_product_category()) ? "true" : "false");
		$window_document_splugins_common_is_item_page = ((is_product()) ? "true" : "false");
		$window_document_splugins_common_is_mobile = ((wbc_is_mobile()) ? "true" : "false");
		

		$inline_script = "
		window.document.splugins.common.current_theme_key = '".$window_document_splugins_common_current_theme_key."'
		window.document.splugins.common.is_shop_page = ".$window_document_splugins_common_is_shop_page."
		window.document.splugins.common.is_category_page =".$window_document_splugins_common_is_category_page."
		window.document.splugins.common.is_item_page = ".$window_document_splugins_common_is_item_page."
		window.document.splugins.common.is_mobile = ".$window_document_splugins_common_is_mobile."
		window.document.splugins.common.is_tablet = ".$window_document_splugins_common_is_mobile."
		";
...
// add_action('wp_enqueue_scripts',function(){
	...
	$inline_script = "        console.log('[js.vars.asset wp_footer]');\n" .
